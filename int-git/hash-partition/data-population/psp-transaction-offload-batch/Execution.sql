            ...
            WHILE (BATCH_COUNT > 0 AND PROCESSED_RECORDS < MAX_RECORDS)
                ...
                LOOP
                    BEGIN
                        ...
                        using (SELECT ceei.TRANSACTION_OFFLOAD_BATCH_SEQ, cei.COMPANY_FK
                               FROM PSPADM.PSP_TRANSACTION_OFFLOAD_BATCH ceei,
                                    PSPADM.PSP_FINANCIAL_TRANSACTION cei
                               WHERE cei.CREATED_DATE between START_DATE and PARTITION_END_DATE
                                 AND ceei.FINANCIAL_TRANSACTION_FK = cei.FINANCIAL_TRANSACTION_SEQ
                                 AND ceei.COMPANY_FK is null
