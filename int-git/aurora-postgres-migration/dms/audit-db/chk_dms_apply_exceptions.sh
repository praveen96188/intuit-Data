...
EOF
    ...
    cluster_postgres=${rds_instance::-1}
    ./run_postgres.sh ${cluster_postgres} $db_name apply_exceptions_report_o2p_count.sql "-v dbname=${db_name}" > ${db_name}_dms_apply_exceptions_new.txt
else
