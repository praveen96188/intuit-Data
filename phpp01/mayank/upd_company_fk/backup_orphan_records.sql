...
spool upd_company_fk/backup_orphan_records
...
--1886
select count(*) from MCHOUBEY.PSP_PSTUB_DDITEM_TEMP_PSP_25432;
...
--1901
select count(*) from MCHOUBEY.PSP_PSTUB_MSG_TEMP_PSP_25432;
...
--5517
select count(*) from MCHOUBEY.PSP_PSTUB_PAID_TIMEOFF_ITEM_TEMP_PSP_25432;

--PSP_PSTUB_PAY_ITEM
create table MCHOUBEY.PSP_PSTUB_PAY_ITEM_PSP_25432 as
select/*+ parallel(8) */* from PSPADM.PSP_PSTUB_PAY_ITEM where COMPANY_FK is null;

--28724
select count(*) from MCHOUBEY.PSP_PSTUB_PAY_ITEM_PSP_25432;
...
--3388
select count(*) from MCHOUBEY.PSP_PAYSTUB_TEMP_PSP_25432;
...
--132903
select count(*) from MCHOUBEY.PSP_EFTPS_PAYMENT_DETAIL_TEMP_PSP_25432;
...
--51
select count(*) from MCHOUBEY.PSP_VOIDED_CHECK_TEMP_PSP_25432;
...
--393
select count(*) from MCHOUBEY.PSP_FSET_FILING_DETAIL_TEMP_PSP_25432;
...
--56
select count(*) from MCHOUBEY.PSP_QBDT_TRANSACTION_INFO_TEMP_PSP_25432;
...
--2571
select count(*) from MCHOUBEY.PSP_QBDT_PAYLINE_INFO_TEMP_PSP_25432;
...
--18
select count(*) from MCHOUBEY.PSP_FINANCIAL_TRANS_STATE_TEMP_PSP_25432;
...
--859
select count(*) from MCHOUBEY.PSP_TAX_PAYMENT_ON_HOLD_REASON_TEMP_PSP_25432;
...
--501125
select count(*) from MCHOUBEY.PSP_TRANSACTION_OFFLOAD_BATCH_TEMP_PSP_25432;
