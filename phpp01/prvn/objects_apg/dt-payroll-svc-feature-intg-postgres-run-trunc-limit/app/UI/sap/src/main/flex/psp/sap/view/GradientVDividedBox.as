package psp.sap.view
{
	...
	public class GradientVDividedBox extends VDividedBox
	{		
		/* ----------------------------- Variables ----------------------------- */			
		...
		[Inspectable(category="General", enumeration="vertical,horizontal,rotated", defaultValue="vertical")]	
		public function set gradientDirection(value:String):void	{		
			_gradientDirection = value;		invalidateDisplayList();	
		}	
		...
		public function set r(value:Number):void {		
			_r = value;		invalidateDisplayList();	
		}	
		...
		[Inspectable(category="General", enumeration="linearRGB,rgb", defaultValue="linearRGB")]	
		...
		/* ----------------------------- Variables ----------------------------- */	
		public function GradientVDividedBox() {		
			super();		
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void {            
			...
			var h:Number = unscaledHeight - b.top - b.bottom;           
		 	...
		 	g.clear();            
		 	g.beginGradientFill(_gradientType, _colors, alphaArray, ratioArray, m, SpreadMethod.PAD, _interpolationMethod);
		 	var cn:uint = this.getStyle("cornerRadius");            
		 	GraphicsUtil.drawRoundRectComplex(g, b.left, b.top, w, h, cn, cn, cn, cn);                
		 	g.endFill();        
		 }     	
		 
		 private function rotatedGradientMatrix(x:Number, y:Number,	width:Number, height:Number, rotation:Number):Matrix {		
