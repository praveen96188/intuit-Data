package test.sap.viewModel
{
	...
	import psp.sap.viewmodel.GlobalPaymentsExceptionTabViewModel;
	import psp.sap.viewmodel.events.ViewModelEvent;
	
	import test.mock.MockTaxService;

	// todo add import statements
	public class GlobalPaymentsExceptionTabViewModelTest extends AbstractPartViewModelTestBase
	{
		private var mViewModel:GlobalPaymentsExceptionTabViewModel = new GlobalPaymentsExceptionTabViewModel();
		private var mDataService:MockTaxService; // todo add mock service type;

		public function GlobalPaymentsExceptionTabViewModelTest(methodName:String=null)
		{
			super(methodName);
		}

		public static function suite() : TestSuite {
			return new TestSuite( GlobalPaymentsExceptionTabViewModelTest );
		}
		...
		override public function testViewModel():void {
			//mDataService.expects("getExceptionTaxQueueItems").withArgs(null, null, null, null,  null, null, null, null,  null, false, 0, 25);
        ...
        /*
		protected function getAutoLogin():User {
			return mSAP.lookupService.users.getItemByKey("AL_admin") as User;
		}
		*/
		...
		override protected function testBindableProperties():void {
			...
			//testBindableProperty(mViewModel, "selectedAgent", getAutoLogin()); // todo add a valid value here
