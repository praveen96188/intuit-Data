package psp.sap.validators
{
	...
	Given a set of fields {F}, {F} is valid by the AtLeastOneFieldValidator
	iff there is exists f in {F} s.t. value(f) is not empty

	*/



	public class AtLeastOneFieldValidator extends Validator
	{
		...
		//defaults
		public var errorMessage:String = "One of these fields is required.";
		...
		public function AtLeastOneFieldValidator()
		{
			super();
		...
		*/
		...
		override protected function doValidation(value:Object):Array
	    {
			...
			if (results.length > 0 || ((val.length == 0) && !required))
			    ...
			    return atLeastOneFieldValidation(value);
	    }	  
		...
		*/
		protected function atLeastOneFieldValidation(value:Object):Array
	    {
	    	var results:Array = [];
