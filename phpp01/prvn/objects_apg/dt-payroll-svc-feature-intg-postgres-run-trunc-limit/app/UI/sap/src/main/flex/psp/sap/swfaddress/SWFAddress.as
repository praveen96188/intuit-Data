 ...
 */
package psp.sap.swfaddress{
    import psp.sap.swfaddress.*;
     ...
     */
    [Event(name='init', type='psp.sap.swfaddress.SWFAddressEvent')]
    /**
     * Dispatched when any value change.
     */
    [Event(name='change', type='psp.sap.swfaddress.SWFAddressEvent')]
    /**
     * Dispatched when value was changed by Flash.
     */
    [Event(name='internalChange', type='psp.sap.swfaddress.SWFAddressEvent')]
    /**
     * Dispatched when value was changed by Browser.
     */
    [Event(name='externalChange', type='psp.sap.swfaddress.SWFAddressEvent')]
