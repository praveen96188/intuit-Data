package test.sap.viewModel
{
	...
	import psp.sap.viewmodel.GlobalPaymentsPendingTabViewModel;
	import psp.sap.viewmodel.events.ViewModelEvent;
	
	import test.mock.MockTaxService;

	// todo add import statements
	public class GlobalPaymentsPendingTabViewModelTest extends AbstractPartViewModelTestBase
	{
		private var mViewModel:GlobalPaymentsPendingTabViewModel = new GlobalPaymentsPendingTabViewModel();
		private var mDataService:MockTaxService;

		public function GlobalPaymentsPendingTabViewModelTest(methodName:String=null)
		{
			super(methodName);
		}

		public static function suite() : TestSuite {
			return new TestSuite( GlobalPaymentsPendingTabViewModelTest );
		}
		...
		override public function testViewModel():void {
			//mDataService.expects("getPendingTaxQueueItems").withArgs(null, null, null,  null, null, null, null,  null, false, 0, 25);
