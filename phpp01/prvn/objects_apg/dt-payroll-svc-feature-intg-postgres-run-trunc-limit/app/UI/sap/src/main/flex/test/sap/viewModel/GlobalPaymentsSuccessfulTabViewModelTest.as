package test.sap.viewModel
{
	...
	import psp.sap.viewmodel.GlobalPaymentsSuccessfulTabViewModel;
	...
	public class GlobalPaymentsSuccessfulTabViewModelTest extends AbstractPartViewModelTestBase
	{
		private var mViewModel:GlobalPaymentsSuccessfulTabViewModel = new GlobalPaymentsSuccessfulTabViewModel();
		private var mDataService:MockTaxService;


		public function GlobalPaymentsSuccessfulTabViewModelTest(methodName:String=null)
		{
			super(methodName);
		}

		public static function suite() : TestSuite {
			return new TestSuite( GlobalPaymentsSuccessfulTabViewModelTest );
		}
...
//			mDataService.expects("getSuccessfulTaxQueueItems").withArgs(null, null, null,  null, null, null, null,  null, false, 0, 25);
