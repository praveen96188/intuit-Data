package psp.sap.view.controls {
    ...
    public class SAPComboBox extends ComboBox{

        private var mViewModel:AbstractPartViewModel;
        private var mDataField:String;
        private var mCrawlParents:Boolean = true;

        [Bindable] public var bindToIndex:Boolean = false;

        public function SAPComboBox() {
            super();
        ...
        private function setupViewModelBindings():void {
            ...
            if(bindToIndex){
                BindingUtils.bindProperty(this, "selectedIndex", viewModel, paths);
            }
            else {
                BindingUtils.bindProperty(this, "selectedItem", viewModel, paths);
            }
        }
        ...
        private function bindControlToTarget(event:ViewModelEvent):void {
            ...
            if(source != null){
                if(bindToIndex){
                    this.selectedIndex = source[targeProperty];
                    BindingUtils.bindProperty(source, targeProperty, this, "selectedIndex");
                }
                else {
                    this.selectedItem = source[targeProperty];
                    BindingUtils.bindProperty(source, targeProperty, this, "selectedItem");
                }
            }
        }
