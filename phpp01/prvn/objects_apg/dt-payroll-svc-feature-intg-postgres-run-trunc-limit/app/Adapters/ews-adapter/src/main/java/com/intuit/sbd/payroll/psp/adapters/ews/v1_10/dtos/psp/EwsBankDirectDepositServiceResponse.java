...
public class EwsBankDirectDepositServiceResponse extends EwsBaseServiceResponse implements Cloneable {

    @XmlElement(name = "BankAccount", required = true)
    protected EwsBaseBankAccountResponse ewsBaseBankAccountResponse;

    public EwsBankDirectDepositServiceResponse clone() throws CloneNotSupportedException {
        EwsBankDirectDepositServiceResponse clone = (EwsBankDirectDepositServiceResponse) super.clone();
