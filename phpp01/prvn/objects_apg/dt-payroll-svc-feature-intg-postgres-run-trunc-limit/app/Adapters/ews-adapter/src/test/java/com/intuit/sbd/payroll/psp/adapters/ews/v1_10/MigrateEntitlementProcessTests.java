...
import com.intuit.sbd.payroll.psp.adapters.ews.v1_10.processes.MigrateEntitlementProcess;
...
public class MigrateEntitlementProcessTests {
    ...
    @Test
    public void migrateEntitlementFromDIYtoAssisted() throws Exception {
        assistedTest = true;
        ...
        PayrollServicesTest.validateSourceSystemTransmission(PayrollServicesTest.getSourceSystem(company.getId().toString(), SourceSystemCode.EWS, SourceSystemCode.PSP,
                        TransmissionType.MigrateEntitlement),"v1_10/test_migrateEntitlementFromDIYtoAssisted.xml",
                Arrays.asList("DateTimeStamp", "PSID", "ServiceKey", "SubscriptionNumber"));
    }
