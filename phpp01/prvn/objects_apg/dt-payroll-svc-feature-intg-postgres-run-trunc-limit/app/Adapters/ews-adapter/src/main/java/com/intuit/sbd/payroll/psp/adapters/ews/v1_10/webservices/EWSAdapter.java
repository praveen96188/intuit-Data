package com.intuit.sbd.payroll.psp.adapters.ews.v1_10.webservices;

import com.intuit.sbd.payroll.psp.adapters.ews.v1_10.dtos.as400.GetPayrollInfoWSDTO;
import com.intuit.sbd.payroll.psp.adapters.ews.v1_10.dtos.as400.PayrollInfoWSDTO;
import com.intuit.sbd.payroll.psp.adapters.ews.v1_10.dtos.psp.*;
import com.intuit.sbd.payroll.psp.adapters.ews.v1_10.processes.*;
...
public class EWSAdapter {
    ...
    private static final SpcfLogger logger = PayrollServices.getLogger(EWSAdapter.class);
    ...
    @WebMethod()
    @WebResult(name = "DeactivateEntitlementResponse")
    public EwsResponse Deactivate_Entitlement(@WebParam(name = "DeactivateEntitlement") EwsDeactivateEntitlement pRequest) {
        DeactivateEntitlementProcess process = new DeactivateEntitlementProcess(pRequest);
        return process.execute();
    }

    @WebMethod()
    @WebResult(name = "QueryIndustryListResponse")
    public EwsQueryIndustryListResponse Query_Industry_Types(@WebParam(name = "QueryIndustryTypes")EwsQueryIndustryList pRequest) {
        QueryIndustryListProcess process = new QueryIndustryListProcess(pRequest);
        return process.execute();
    }
}
