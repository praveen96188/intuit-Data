...
public class EwsDeactivateService extends EwsRequest implements Cloneable {
    ...
    public EwsDeactivateService clone() throws CloneNotSupportedException {
        EwsDeactivateService clone = (EwsDeactivateService) super.clone();
