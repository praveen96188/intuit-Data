...
public class EwsQueryAccountResponse extends EwsResponse implements Cloneable {
    ...
    public EwsQueryAccountResponse() {
        super();
    }

    public EwsQueryAccountResponse clone() throws CloneNotSupportedException {
        EwsQueryAccountResponse clone = (EwsQueryAccountResponse) super.clone();
