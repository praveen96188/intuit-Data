...
public class EwsSubscriptionResponse implements Cloneable {
    ...
    @XmlElement(name = "EwsEntitlementUnitInfo", required = false)
    protected List<EwsEntitlementUnitInfo> ewsEntitlementUnitInfo;
    ...
    public List<EwsEntitlementUnitInfo> getEwsEntitlementUnitInfo() {
        return ewsEntitlementUnitInfo;
    }

    public void setEwsEntitlementUnitInfo(List<EwsEntitlementUnitInfo> pEwsEntitlementUnitInfo) {
        ewsEntitlementUnitInfo = pEwsEntitlementUnitInfo;
    }
}
