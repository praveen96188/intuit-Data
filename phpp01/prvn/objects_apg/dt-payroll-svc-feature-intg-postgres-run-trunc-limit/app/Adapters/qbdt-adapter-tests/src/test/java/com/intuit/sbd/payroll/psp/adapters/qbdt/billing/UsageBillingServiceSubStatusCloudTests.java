...
public class UsageBillingServiceSubStatusCloudTests extends UsageBillingTestsBase{

    private ServiceSubStatusCode subStatusCode;
    private String subStatusName;

    public UsageBillingServiceSubStatusCloudTests(ServiceSubStatusCode ssc, String name) {
    ...
    public static Collection<Object[]> data() {
        Object[][]  substatusList= new Object[][]{
                ...
                {ServiceSubStatusCode.Fraud,"Fraud"},
                ...
                {ServiceSubStatusCode.PendingTermination,"PendingTermination"},
                {ServiceSubStatusCode.RiskCollections,"RiskCollections"},
