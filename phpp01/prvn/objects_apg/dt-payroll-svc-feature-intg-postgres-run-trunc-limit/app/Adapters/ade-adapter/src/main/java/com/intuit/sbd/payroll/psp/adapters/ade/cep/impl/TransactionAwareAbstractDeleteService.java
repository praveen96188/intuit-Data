...
import com.intuit.ems.cep.api.AbstractDeleteService;
 ...
 * Time: 2:07 PM
 */
public abstract class TransactionAwareAbstractDeleteService<T, S extends ServiceParams> extends AbstractDeleteService<T, S> {
