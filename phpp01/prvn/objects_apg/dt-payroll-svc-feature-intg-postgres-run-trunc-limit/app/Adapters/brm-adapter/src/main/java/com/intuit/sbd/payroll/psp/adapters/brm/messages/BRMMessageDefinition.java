...
/**
 * Message definitions for the BRM Webservices (adapted from the DIS Adapters)
 */
class BRMMessageDefinition {
    private static SpcfLogger logger = SpcfLogManager.getLogger(BRMMessageDefinition.class);

    public static final String DEFAULT_BUNDLE_NAME = "resources/BRMMessageDefinitions";
    ...
    public static void loadBundle(String bundleName) {
        try {
            ...
            String message = "Unable to load BRMMessageDefinition bundle: " + bundleName;
     ...
     */
    public static BRMMessageDefinition getMessageDefinition(int messageNumber) {
        BRMMessageDefinition definition = new BRMMessageDefinition();
