...
import com.intuit.sbd.payroll.psp.adapters.dis.v1_7.disdtos.requests.QueryUpdatedCompaniesRequestDISDTO;
import com.intuit.sbd.payroll.psp.adapters.dis.v1_7.disdtos.responses.QueryUpdatedCompaniesResponseDISDTO;
...
/**
 * $Author: JChickanosky $
 * $File: //PSP/dev/Adapters/DIS/src/com/intuit/sbd/payroll/psp/adapters/dis/v1_7/processes/psp/PSPQueryUpdatedCompanies.java $
 * $Revision: #1 $
...
public class PSPQueryUpdatedCompanies extends DISProcessInterface {
    ...
    private DomainEntitySet<CompanyService> queryPSPForNewCompanies(Calendar pStartDate, Calendar pEndDate, ServiceCode pServiceCode) {
        ...
        if (pEndDate != null) {
            ...
            companyserviceCriterion = companyserviceCriterion.And(CompanyService.CreatedDate().lessOrEqualThan(endDateSpcfCal));
