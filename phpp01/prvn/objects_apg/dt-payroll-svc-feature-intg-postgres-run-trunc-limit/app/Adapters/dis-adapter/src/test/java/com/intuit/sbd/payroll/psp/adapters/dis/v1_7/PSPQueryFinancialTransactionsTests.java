...
public class PSPQueryFinancialTransactionsTests {
    ...
    public static void loadDataHappyPath() {
        ...
        payrollRunid = payrollRun1.getId();
    ...
    public void testSingleTransaction() {
        try {
            ...
            PayrollServices.beginUnitOfWork();
            payrollRun1 = PayrollRun.findPayrollRun(payrollRunid);
    ...
    private static PayrollRun runPayroll(Company company, DateDTO date, String amount) {
        ...
        System.out.println("PayrollRunDTO = " + payrollRunDTO.getPaychecks());
        ...
        System.out.println("ATC Count is "+processResult.getResult().getFinancialTransactions(TransactionTypeCode.AgencyTaxCredit).size());
        PayrollServices.commitUnitOfWork();
