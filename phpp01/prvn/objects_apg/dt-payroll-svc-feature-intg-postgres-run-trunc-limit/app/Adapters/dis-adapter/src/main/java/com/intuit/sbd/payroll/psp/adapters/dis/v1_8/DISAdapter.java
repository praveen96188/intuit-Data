...
import com.intuit.sbd.payroll.psp.adapters.dis.v1_8.disdtos.requests.*;
import com.intuit.sbd.payroll.psp.adapters.dis.v1_8.disdtos.responses.*;
import com.intuit.sbd.payroll.psp.adapters.dis.v1_8.processes.DISProcessInterface;
import com.intuit.sbd.payroll.psp.adapters.dis.v1_8.processes.psp.PSPAuthenticate;
import com.intuit.sbd.payroll.psp.adapters.dis.v1_8.processes.psp.*;
...
public class DISAdapter {
    ...
    @WebResult(name = DIS_RESPONSE_RESULT_XML_STR)
    public QueryCompanyLatestPayrollDatesResponseDISDTO Query_CompanyLatestPayrollDates(@WebParam(name = "QueryCompanyPayrollDatesRequest", targetNamespace = "http://v1_8.dis.adapters.psp.payroll.sbd.intuit.com/") QueryCompanyLatestPayrollDatesRequestDISDTO pQueryCompanyPayrollDatesRequestDISDTO) {
    ...
    @WebResult(name = DIS_RESPONSE_RESULT_XML_STR)
    public QueryCompanyEventsResponseDISDTO Query_CompanyEvent(@WebParam(name = "QueryCompanyEventsRequest", targetNamespace = "http://v1_8.dis.adapters.psp.payroll.sbd.intuit.com/") QueryCompanyEventsRequestDISDTO pQueryCompanyEventsRequestDISDTO) {
