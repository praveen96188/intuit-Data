...
/**
 * $Author: JChickanosky $
 * $File: //PSP/dev/Adapters/DIS/src/com/intuit/sbd/payroll/psp/adapters/dis/v1_7/disdtos/requests/QueryCompanyLatestPayrollDatesRequestDISDTO.java $
 * $Revision: #1 $
 * $DateTime: 2012/10/03 10:58:39 $
 * $Author: JChickanosky $
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "QueryCompanyPayrollDatesRequest")
@XmlType()
public class QueryCompanyLatestPayrollDatesRequestDISDTO {
