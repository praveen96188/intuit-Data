...
public enum SelectionEnum {
    ...
    PITEMS("PItem", "Select TaxItem", "Select TaxItem",getSupportedRoles("RTBAutomationAdmin")),
    TAXITEMS("TaxItem", "Select Pitem", "Select Pitem",getSupportedRoles("RTBAutomationAdmin"));
    ...
    SelectionEnum(String pId, String pShortDescription, String pDescription,  Set pSupportedRoles) {
    ...
    public static List<SAPRTBAutomationJob> getSAPRTBJobListForRole(List<String> roleIds) {
        ...
        for (SelectionEnum rtbJob : values()) {
