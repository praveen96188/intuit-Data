 ...
 */
public class C03NoticeOfChangeReturnTests {
    ...
    public void testMeetsCriteria() {
        ...
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(false, "C03", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        assertEquals("Returned Handler", C03NoticeOfChangeReturn.class, returnHandler.getClass());
    }
    ...
    @Test
    public void testProcessC03NoticeOfChangeCBAInActive() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(false, "C03", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        //verify bank account number and routing number are not updated
    ...
    @Test
    public void testC03NoticeOfChange_CBAChangedBeforeOffload() {
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        PayrollServices.beginUnitOfWork();
        ...
        DomainEntitySet<TransactionReturn> returnList = loader.createNoticeOfChange(false, "C03", "");
        PayrollServices.commitUnitOfWork();
...
//        finTxnList = TransactionReturn.findFinancialTransaction(transactionReturn);
    ...
    @Test
    public void testProcessC03NoticeOfChangeEmployeeBankAccountNumber() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChangeEmployeeBankAccount("C03", "");
        PayrollServices.commitUnitOfWork();
    ...
    @Test
    public void testProcessC03NoticeOfChangePayeeBankAccountNumber() {

        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChangePayeeBankAccount("C03", "");
    ...
    public void testInvalidCorrectedFieldCompanyNoteRule() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(true, "C03", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        for (CompanyNote domainNote : finTxn.getCompany().getCompanyNoteCollection()) {
            assertEquals("Company Note:", "An erroneous NOC with change code 'C03' was received for company " +
                    ...
                    "blank, which is invalid. The NOC was left unresolved and no action was taken against the " +
