 ...
 */
public class C02NoticeOfChangeReturnTests {
    @Before
    ...
    public void testMeetsCriteria() {
        ...
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(false, "C02", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        assertEquals("Returned Handler", C02NoticeOfChangeReturn.class, returnHandler.getClass());
    }

    @Test
    public void testProcessC02NoticeOfChangeCompanyBankAccountNumber() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(false, "C02", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
    ...
    @Test
    public void testProcessC02NoticeOfChange_CBAInActive() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(false, "C02", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        //verify bank routing number is not updated
    ...
    @Test
    public void testC02NoticeOfChange_CBAChangedBeforeOffload() {
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        PayrollServices.beginUnitOfWork();
        ...
        DomainEntitySet<TransactionReturn> returnList = loader.createNoticeOfChange(false, "C02", "");
        PayrollServices.commitUnitOfWork();
...
//        finTxnList = TransactionReturn.findFinancialTransaction(transactionReturn);
    ...
    @Test
    public void testProcessC02NoticeOfChangeEmployeeBankAccountNumber() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChangeEmployeeBankAccount("C02", "");
        PayrollServices.commitUnitOfWork();
    ...
    @Test
    public void testProcessC02NoticeOfChangePayeeBankAccountNumber() {

        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChangePayeeBankAccount("C02", "");
    ...
    public void testInvalidCorrectedFieldCompanyNoteRule() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(true, "C02", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        for (CompanyNote domainNote : finTxn.getCompany().getCompanyNoteCollection()) {
            assertEquals("Company Note:", "An erroneous NOC with change code 'C02' was received for company " +
                    "bank account id '" + companyBankAccount.getSourceBankAccountId() + "'.  The current bank account " +
                    "routing number is '" + bankAccount.getRoutingNumber() + "', the corrected value provided for this " +
                    "field in the NOC was blank, which is invalid. The NOC was left unresolved and no action was " +
