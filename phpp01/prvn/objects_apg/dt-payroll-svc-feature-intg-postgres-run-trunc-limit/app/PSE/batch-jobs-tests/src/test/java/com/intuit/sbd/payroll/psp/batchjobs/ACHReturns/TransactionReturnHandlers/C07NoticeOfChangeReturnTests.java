 ...
 */
public class C07NoticeOfChangeReturnTests {
    @Before
    ...
    public void testMeetsCriteria() {
        ...
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(false, "C07", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        assertEquals("Returned Handler", C07NoticeOfChangeReturn.class, returnHandler.getClass());
    }

    @Test
    public void testProcessC07NoticeOfChangeCompanyBankAccountNumber() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(false, "C07", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        String routingNumber = NoticeOfChangeUtils.getCorrectedBankRoutingNumber(transactionReturn);
        ...
        //Update Bank Routing Number Rule
        assertEquals("Bank Routing Number", bankAccount.getRoutingNumber(), routingNumber);
        ...
        for (CompanyEvent companyEvent : companyEventsList) {
            ...
            assertEquals("New Account Type", EnumUtils.getReadableName(bankAccount.getAccountTypeCd()),
                    companyEvent.getCompanyEventDetailValue(EventDetailTypeCode.NewAccountType));

            assertEquals("Old Routing Number", oldRoutingNumber,
                    companyEvent.getCompanyEventDetailValue(EventDetailTypeCode.OldRoutingNumber));

            assertEquals("New Routing Number", bankAccount.getRoutingNumber(),
                    companyEvent.getCompanyEventDetailValue(EventDetailTypeCode.NewRoutingNumber));
    ...
    @Test
    public void testProcessC07NoticeOfChangeCBAInActive() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(false, "C07", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        //verify bank account number, routing number and type are not updated
        assertEquals("Bank Account Number", oldAccountNumber, bankAccount.getAccountNumber());
        assertEquals("Bank Routing Number", oldRoutingNumber, bankAccount.getRoutingNumber());
    ...
    @Test
    public void testC07NoticeOfChange_CBAChangedBeforeOffload() {
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        PayrollServices.beginUnitOfWork();
        ...
        DomainEntitySet<TransactionReturn> returnList = loader.createNoticeOfChange(false, "C07", "");
        PayrollServices.commitUnitOfWork();
...
//        finTxnList = TransactionReturn.findFinancialTransaction(transactionReturn);
    ...
    @Test
    public void testProcessC07NoticeOfChangeEmployeeBankAccountNumber() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChangeEmployeeBankAccount("C07", "");
        PayrollServices.commitUnitOfWork();
    ...
    @Test
    public void testProcessC07NoticeOfChangePayeeBankAccountNumber() {

        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChangePayeeBankAccount("C07", "");
    ...
    public void testInvalidCorrectedFieldCompanyNoteRule() {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange(true, "C07", "", SourceSystemCode.QBOE);
        PayrollServices.commitUnitOfWork();
        ...
        for (CompanyEvent companyEvent : companyEventsList) {
            ...
            assertEquals("New Routing Number", "INVALID",
                    companyEvent.getCompanyEventDetailValue(EventDetailTypeCode.NewRoutingNumber));
        ...
        for (CompanyNote domainNote : finTxn.getCompany().getCompanyNoteCollection()) {
            assertEquals("Company Note:", "An erroneous NOC with change code 'C07' was received for company " +
                    "bank account id '" + companyBankAccount.getSourceBankAccountId() + "'.  The provided bank account number is invalid. " +
                    "The current bank account routing number is '" +
                    bankAccount.getRoutingNumber() + "', the corrected value provided for this field in the NOC was " +
                    "blank, which is invalid. The current bank account type code is '" +
    ...
    public void testERLedgerDebitNOC() throws Exception {
        PayrollServices.beginUnitOfWork();
        ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
        DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange("C07", "0653054364847474748       42", SourceSystemCode.QBDT);
        PayrollServices.commitUnitOfWork();
        ...
        assertEquals("4847474748", companyBankAccount.getBankAccount().getAccountNumber());
        assertEquals("065305436", companyBankAccount.getBankAccount().getRoutingNumber());
        ...
        public void testERLoanDebitNOC() throws Exception {
            PayrollServices.beginUnitOfWork();
            ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
            DomainEntitySet<TransactionReturn> returnList = loader.loadDataForNoticeOfChange("C07", "0653054364847474748       52", SourceSystemCode.QBDT);
            PayrollServices.commitUnitOfWork();
        ...
        public void testEELedgerCreditNOC() throws Exception {
            PayrollServices.beginUnitOfWork();
            ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
            TransactionReturn transactionReturn = loader.loadQBDTDataWithOneNOCReturn("C07", null, "EE1_1", "06530543612346            42");
            PayrollServices.commitUnitOfWork();
        ...
        public void testEELoanCreditNOC() throws Exception {
            PayrollServices.beginUnitOfWork();
            ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
            TransactionReturn transactionReturn = loader.loadQBDTDataWithOneNOCReturn("C07", null, "EE1_1", "06530543612346            52");
            PayrollServices.commitUnitOfWork();
        ...
        public void testPayeeLedgerCreditNOC() throws Exception {
            ...
            ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
            TransactionReturn transactionReturn = loader.loadDataForSingleNoticeOfChangePayeeBankAccount("C07", null, "11100061412346            42").getFirst();
        ...
        public void testPayeeLoanCreditNOC() throws Exception {
            ACHReturnsDataLoader loader = new ACHReturnsDataLoader();
            TransactionReturn transactionReturn = loader.loadDataForSingleNoticeOfChangePayeeBankAccount("C07", null, "11100061412346            52").getFirst();
