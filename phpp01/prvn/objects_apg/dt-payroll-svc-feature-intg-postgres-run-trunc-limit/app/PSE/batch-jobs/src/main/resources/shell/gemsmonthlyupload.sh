...
$JAVA_HOME/java $JAVA_OPTS $LOGGER_PROPS -classpath $BE_CLASSPATH com.intuit.sbd.payroll.psp.batchjobs.GEMSUpload.MonthlyGemsUploadBatchProcess $1 $2 >$BE_LOG/gemsmonthlyupload.out.`date +%Y%m%d%H%M%S` 2>&1
