...
/**
 * Implementation to reEngage employees invited previously via the batch
 */
@Service
public class SendReEngageAutoInvites extends SendWorkforceInvitesAbstract implements SendWorkforceInvites {
    ...
    public List<SpcfUniqueId> getEmployeesForInvitationMode(SpcfUniqueId companyId, Map<String, Object> queryParams) {
        ...
        List<SpcfUniqueId> employeeIdList= Employee.getWorkforceReInviteEmployeeListForCompany(companyId, lastPaidDurationEmployee,
                settlementDateDuration, isDDQuery, false, latestInviteDate, maxPreviousBulkInviteLimit);
    ...
    public String getInvitationSource() {
        ...
        return InvitationMode.ReEngageAutoInvited.getInvitationSource();
    }

    @Override
    public InvitationMode getInvitationMode() {
        return InvitationMode.ReEngageAutoInvited;
    }
}
