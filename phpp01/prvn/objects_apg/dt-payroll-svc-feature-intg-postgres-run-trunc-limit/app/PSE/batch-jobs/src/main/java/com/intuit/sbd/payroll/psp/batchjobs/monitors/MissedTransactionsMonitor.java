 ...
 */
public class MissedTransactionsMonitor extends BatchJobProcessorMonitor {
    public MissedTransactionsMonitor(RunMode pRunMode, BatchJobType pBatchJobType, String pJobId, String pJobIdToMonitor) {
        super(pRunMode,
              pBatchJobType,
              pJobId,
              pJobIdToMonitor,
    ...
    public void execute() {
        ...
        executeStep(new MissedTransactionsMonitorProcessorStep());
    }

    public class MissedTransactionsMonitorProcessorStep extends BatchJobProcessorStep {
        //
