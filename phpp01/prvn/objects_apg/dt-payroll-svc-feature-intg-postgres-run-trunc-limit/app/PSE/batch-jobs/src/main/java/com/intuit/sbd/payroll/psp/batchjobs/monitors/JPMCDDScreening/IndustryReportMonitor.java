 ...
 */
public class IndustryReportMonitor extends BatchJobProcessorMonitor {
    public IndustryReportMonitor(BatchJobProcessor.RunMode pRunMode, BatchJobType pBatchJobType, String pJobId, String pJobIdToMonitor) {
        super(pRunMode,
              pBatchJobType,
              pJobId,
              pJobIdToMonitor,
              BatchJobType.IndustryReportProcessor,
             IndustryReportProcessor.ArchiveFileStep.class);
    }
