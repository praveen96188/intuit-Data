 ...
 * Time: 3:58:03 PM
 */
@ScheduledJob(name = "ATFCompanyTaxRateExtract", resourcePath = "/normal", autoScheduleGenerator = JSSAutoScheduleGenerator.class, scheduleGenerator = JSSScheduleGenerator.class)
public class CompanyTaxRateExtractProcess extends BaseATFExtractFileProcess {
    ...
    public CompanyTaxRateExtractProcess(String[] pArguments) {
        super(pArguments);
        init();
    }

    public CompanyTaxRateExtractProcess(String[] pArguments, String pJobId) {
    ...
    protected void writeData(PrintWriter pPW) throws Throwable {
        ...
        List<com.intuit.sbd.payroll.psp.batchjobs.ATFDataExtract.CompanyTaxRateExtractProcess.CompanyTaxRateInfo> companyTaxRateInfoResults = findCompanyTaxRateInfoResults(lastRunDate);

        for (int i = 0; i < companyTaxRateInfoResults.size(); i++) {
            com.intuit.sbd.payroll.psp.batchjobs.ATFDataExtract.CompanyTaxRateExtractProcess.CompanyTaxRateInfo companyTaxRateInfoResult = companyTaxRateInfoResults.get(i);
            ...
            if (companyTaxRateInfoResults.size() > i + 1) {
                com.intuit.sbd.payroll.psp.batchjobs.ATFDataExtract.CompanyTaxRateExtractProcess.CompanyTaxRateInfo nextCompanyTaxRateInfo = companyTaxRateInfoResults.get(i + 1);
...
*/
    ...
    private void writeRecordsToFile(String pSourceCompanyId, String pSourceTaxCd, Double pRate, SpcfCalendar pEffectiveDate, SpcfCalendar pExpirationDate, PgpWriter pPrintWriter) throws Throwable {
        pPrintWriter.write(DOUBLE_QUOTE);
        //ATF Extract type Id
        pPrintWriter.write(ATF_EXTRACT_TYPE_ID + DELIMITER);
        //Source System Id
     ...
     * @return  List
     */
    private static List<com.intuit.sbd.payroll.psp.batchjobs.ATFDataExtract.CompanyTaxRateExtractProcess.CompanyTaxRateInfo> findCompanyTaxRateInfoResults(SpcfCalendar startDate) {
    ...
    //ToDo For now using the CompanyTaxRateInfo from the batchjobs(flux) package. To be resolved when the migration is complete
