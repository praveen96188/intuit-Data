 ...
 */
public class NightlyBatchJobsMonitor extends BatchJobProcessorMonitor {
    public NightlyBatchJobsMonitor(RunMode pRunMode, BatchJobType pBatchJobType, String pJobId, String pJobIdToMonitor) {
        super(pRunMode,
              pBatchJobType,
              pJobId,
              pJobIdToMonitor,
              BatchJobType.NightlyBatchJobs,
              NightlyBatchJobsProcessor.DownloadAchReturnsFile.class);
    }
