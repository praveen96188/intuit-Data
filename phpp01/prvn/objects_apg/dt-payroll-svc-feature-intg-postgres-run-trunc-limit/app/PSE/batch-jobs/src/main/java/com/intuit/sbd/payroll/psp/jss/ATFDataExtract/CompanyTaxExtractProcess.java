 ...
 * Time: 3:56:31 PM
 */
@ScheduledJob(name = "ATFCompanyTaxExtract", resourcePath = "/normal", autoScheduleGenerator = JSSAutoScheduleGenerator.class, scheduleGenerator = JSSScheduleGenerator.class)
public class CompanyTaxExtractProcess extends BaseATFExtractFileProcess {
    ...
    public CompanyTaxExtractProcess(String[] pArguments) {
        super(pArguments);
        init();
    }

    public CompanyTaxExtractProcess(String[] pArguments, String pJobId) {
    ...
    private void writeRecordsToFile(String pSourceCompanyId, String pSourceTaxCd, String pAgencyId, String pFilingsInactiveFlag, String pFilingsExemptFlag, PgpWriter pPrintWriter) throws Throwable {
    ...
    private static List findCompanyTaxInfoResults(SpcfCalendar startDate) {
        ...
        if (startDate != null) {
            builder.append("    and (complaw.ModifiedDate >= :startDate or capt.ModifiedDate >= :startDate or serviceInfo.ModifiedDate >= :startDate or qbdtpiteminfo.ModifiedDate >=:startDate ) ");
        }
