 ...
 */
public class ScheduledAchOffloadMonitor extends AchOffloadMonitor {
    public ScheduledAchOffloadMonitor(RunMode pRunMode, BatchJobType pBatchJobType, String pJobId, String pJobIdToMonitor) {
        super(pRunMode,
                pBatchJobType,
                pJobId,
                pJobIdToMonitor,
    ...
    protected void doFinalOffloadChecks() {
        try {
            ...
            // since this is the scheduled (second) offload monitor, we want the latest completed offload batch
