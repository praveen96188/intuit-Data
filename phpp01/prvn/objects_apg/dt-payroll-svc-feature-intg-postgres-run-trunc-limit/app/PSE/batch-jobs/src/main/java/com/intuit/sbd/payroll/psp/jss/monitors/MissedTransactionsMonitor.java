 ...
 */
@ScheduledJob(name = "MissedTransactionsMonitor", resourcePath = "/monitor", autoScheduleGenerator = JSSAutoScheduleGenerator.class, scheduleGenerator = JSSScheduleGenerator.class, singleton = false)
public class MissedTransactionsMonitor extends JSSBatchJobMonitor {
    public MissedTransactionsMonitor(String[] pArguments) {
        super(pArguments);
    }

    public MissedTransactionsMonitor(String[] pArguments, String pJobId) {
    ...
    public Class<?> getBatchJobActionToMonitor() {
        return DailyBatchJobsProcessor.MissedTransactionProcessor.class;
    }
    ...
    public void execute() {
        ...
        executeStep(MissedTransactionsMonitorProcessorStep.class);
    }

    public static class MissedTransactionsMonitorProcessorStep extends JSSBatchJobStep<MissedTransactionsMonitor> {
        //
