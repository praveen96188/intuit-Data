 ...
 */
public class AchReturnsMonitor extends BatchJobProcessorMonitor {
    public AchReturnsMonitor(RunMode pRunMode, BatchJobType pBatchJobType, String pJobId, String pJobIdToMonitor) {
        super(pRunMode,
              pBatchJobType,
              pJobId,
              pJobIdToMonitor,
              BatchJobType.NightlyBatchJobs,
              NightlyBatchJobsProcessor.ProcessAchReturnsBatch.class);
    }
