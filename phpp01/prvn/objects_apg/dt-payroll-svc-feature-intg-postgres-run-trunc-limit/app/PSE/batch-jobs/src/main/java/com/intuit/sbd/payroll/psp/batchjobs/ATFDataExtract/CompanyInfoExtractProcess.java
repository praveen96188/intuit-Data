...
public class CompanyInfoExtractProcess extends BaseATFExtractFileProcess {
    ...
    public CompanyInfoExtractProcess(RunMode pRunMode, BatchJobType pBatchJobType, String pJobId, String pJobInstanceParameters) {
    ...
    protected void writeData(PrintWriter pPW) throws Throwable {
        ...
        try {
            ...
            while (queryResults.next()) {
                i++;
                if (i % 1000 == 0) {
                    logger.info("Completed processing for " + i + " Company Info details..");
                }
