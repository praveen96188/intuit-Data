...
--
-- PURPOSE: 
--   This script will purge  PSP_BATCH_JOB_AUDIT_LOG,       => created more than 5 days ago          
--
-- LOGON AS : PSPADM
...
SPOOL dbupgrade_PSRV001106b.log
...
SELECT COUNT(*) FROM PSP_BATCH_JOB_AUDIT_LOG;


PROMPT .
PROMPT Purge the PSP_BATCH_JOB_AUDIT_LOG data except for the past 30 days ...
...
ALTER TABLE PSP_BATCH_JOB_AUDIT_LOG        SHRINK SPACE COMPACT;

SELECT TO_CHAR(SYSDATE, 'MM.DD.YYYY HH24:MI') AS SHRINK1_TIME FROM DUAL;

ALTER TABLE PSP_BATCH_JOB_AUDIT_LOG        SHRINK SPACE;
