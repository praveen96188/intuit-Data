...
BEGIN
	...
	FROM "USER_TABLES"
	WHERE TABLE_NAME = 'TEMP_PSP_AUTH_OPERATION';

	IF table_exists = 1 THEN
		EXECUTE IMMEDIATE 'DROP TABLE "TEMP_PSP_AUTH_OPERATION" CASCADE CONSTRAINTS';
	END IF;
...
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_PSP_AUTH_OPERATION
(
	"OPERATION_ID" VARCHAR2(255 CHAR) NOT NULL, PRIMARY KEY (OPERATION_ID)
