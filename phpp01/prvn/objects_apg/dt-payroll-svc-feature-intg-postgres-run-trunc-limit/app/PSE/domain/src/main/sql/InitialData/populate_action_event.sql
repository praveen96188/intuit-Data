...
BEGIN
	...
	FROM "USER_TABLES"
	WHERE TABLE_NAME = 'TEMP_ACTION_EVENT';

	IF table_exists = 1 THEN
		EXECUTE IMMEDIATE 'DROP TABLE "TEMP_ACTION_EVENT" CASCADE CONSTRAINTS';
	END IF;
...
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_ACTION_EVENT
(
...
SET  (ae.VERSION, ae.DESCRIPTION, ae.TYPE) =
