...
public class HibernateUtils {
    ...
    private static final String MULTI_TENANT_CONNECTION_PROVIDER = "com.intuit.sbd.payroll.psp.hibernate.multitenancy.ConfigurableMultiTenantConnectionProvider";
    private static final String MULTI_TENANT_IDENTIFIER_RESOLVER = "com.intuit.sbd.payroll.psp.hibernate.multitenancy.TenantIdentifierResolver";
    ...
    private static Configuration getConfiguration() {
        ...
        addMultiTenantProperties(config);
    ...
    private static void addHibernateProperties(Configuration config) {
        config.addProperties(ConfigurationManager.getConfigurationProperties(DatabaseConfigManager.MonolithDbHibernateToken));
    }

    private static void addMultiTenantProperties(Configuration cfg) {
        cfg.setProperty(Environment.MULTI_TENANT, MultiTenancyStrategy.DATABASE.toString());
        cfg.setProperty(Environment.MULTI_TENANT_CONNECTION_PROVIDER, MULTI_TENANT_CONNECTION_PROVIDER);
        cfg.setProperty(Environment.MULTI_TENANT_IDENTIFIER_RESOLVER, MULTI_TENANT_IDENTIFIER_RESOLVER);
    }
