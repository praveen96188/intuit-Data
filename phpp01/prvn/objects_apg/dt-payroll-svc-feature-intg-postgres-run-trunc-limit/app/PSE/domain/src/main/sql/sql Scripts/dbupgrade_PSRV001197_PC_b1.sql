-- FILE NAME    : dbupgrade_PSRV001197_PC_b1.sql
...
SPOOL dbupgrade_PSRV001197_PC_b1.log
...
DROP TABLE INT_PSP_PAYCHECK CASCADE CONSTRAINTS;
...
CREATE INDEX PSP_PAYCHECK_I1 ON PSP_PAYCHECK
  (CREATED_DATE) 
