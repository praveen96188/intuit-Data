...
BEGIN
	...
	FROM "USER_TABLES"
	WHERE TABLE_NAME = 'TEMP_USER_PREFERENCE';

	IF table_exists = 1 THEN
		EXECUTE IMMEDIATE 'DROP TABLE "TEMP_USER_PREFERENCE" CASCADE CONSTRAINTS';
	END IF;
...
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_USER_PREFERENCE
(
...
SET (rt.VERSION, rt.KEY, rt.DEFAULT_VALUE) =
