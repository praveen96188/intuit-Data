...
BEGIN
	...
	FROM "USER_TABLES"
	WHERE TABLE_NAME = 'TEMP_PSP_PAYROLL_FREQUENCY';

	IF table_exists = 1 THEN
		EXECUTE IMMEDIATE 'DROP TABLE "TEMP_PSP_PAYROLL_FREQUENCY" CASCADE CONSTRAINTS';
	END IF;
...
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_PSP_PAYROLL_FREQUENCY
(
	"PAYROLL_FREQ_CD" VARCHAR2(255 CHAR) NOT NULL, 
