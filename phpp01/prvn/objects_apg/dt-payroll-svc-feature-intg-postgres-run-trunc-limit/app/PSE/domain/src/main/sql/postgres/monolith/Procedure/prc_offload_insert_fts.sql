...
-- I think we should use p_offload_date instead of v_psp_date ..
       ...
       INSERT /*+ APPEND */ INTO PSP_FINANCIAL_TRANS_STATE
         ...
         (SELECT
                 ...
                 date_trunc('day', ((v_psp_date AT TIME ZONE 'GMT') AT TIME ZONE 'PDT')) + INTERVAL '12 HOURS', NULL, NULL, FT.FINANCIAL_TRANSACTION_SEQ, 'Executed', NULL, ft.company_fk, ft.transaction_type_fk
