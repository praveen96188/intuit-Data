CREATE OR REPLACE PACKAGE BODY PK_TEST_COMPANY AS
/******************************************************************************
...
******************************************************************************/
  ...
  BEGIN
    ...
    GetCompany (p_DIY_COMPANY_ID);

	GetContacts (p_DIY_COMPANY_ID);

	GetDDInfo (p_DIY_COMPANY_ID);

	GetBankAcct (p_DIY_COMPANY_ID);

	GetEvents (p_DIY_COMPANY_ID);

	GetEmployees (p_DIY_COMPANY_ID);
    ...
    LOOP
      ...
      GetEEBankAcct (p_DIY_COMPANY_ID, i.EMP_SRC_ID);
      
    END LOOP;    
    
	GetPayruns (p_DIY_COMPANY_ID);
    ...
    LOOP
      ...
      GetPaychecks (p_DIY_COMPANY_ID, i.PAYROLL_RUN_SRC_ID);
    ...
    LOOP
      ...
      GetPaycheckSplits (p_DIY_COMPANY_ID, i.PC_SOURCE_PAYCHECK_ID);
    ...
    LOOP
      ...
      GetTxns (p_DIY_COMPANY_ID, i.PAYROLL_RUN_SRC_ID);
          
    END LOOP;    

    
    ResetCompany (p_DIY_COMPANY_ID);
  ...
  IS
    ...
    p_EMPLOYEE_LIST                PK_DIYDDTOPSP_PAYROLLS.refcur_employees;    

    EMP_EMPLOYEE_GSEQ              NUMBER;
    EMP_STATUS_CD                  VARCHAR2(100);
    EMP_SOURCE_EMPLOYEE_ID         VARCHAR2(100);
    EMP_TAX_ID                     VARCHAR2(100);
    EMP_FIRST_NAME                 VARCHAR2(100);
    EMP_MIDDLE_NAME                VARCHAR2(100);
