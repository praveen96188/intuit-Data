...
BEGIN
	...
	FROM "USER_TABLES"
	WHERE TABLE_NAME = 'TEMP_PSP_TRANSACTION_STATE';

	IF table_exists = 1 THEN
		EXECUTE IMMEDIATE 'DROP TABLE "TEMP_PSP_TRANSACTION_STATE" CASCADE CONSTRAINTS';
	END IF;
...
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_PSP_TRANSACTION_STATE
(
