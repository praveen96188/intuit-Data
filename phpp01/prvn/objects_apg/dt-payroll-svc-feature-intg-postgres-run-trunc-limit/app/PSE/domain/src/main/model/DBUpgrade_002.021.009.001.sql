...
Prompt Column RECORD_METADATA;
ALTER TABLE PSP_TP401K_SIGNUP_QUEUE
 ADD (RECORD_METADATA  VARCHAR2(512 CHAR));
...
, 'EntityEventRetry', 'ACHTraceIdProcessor', 'ATFCompanyPayrollItemExtract', 'MassCancelAutoProcessor', 'AccountServiceSyncExceptionProcessor', 'SoxReport', 'MtlTransactionReportEnrichProcessor', 'EntityInitialLoadProcessor', 'EVSCompanyProcessor', 'DataReencryptionProcessor', 'BulkWorkforceInviteProcessor'))
ENABLE NOVALIDATE;
...
PROMPT finished DBUpgrade_002.021.009.001.sql