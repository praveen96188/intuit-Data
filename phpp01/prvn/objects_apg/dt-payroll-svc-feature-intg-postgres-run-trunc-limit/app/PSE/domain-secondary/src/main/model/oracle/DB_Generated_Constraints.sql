...
/
ALTER TABLE PSP_HCM401K_POLICY ADD PRIMARY KEY (HCM401K_POLICY_SEQ, REALM_ID) USING INDEX;
/
ALTER TABLE PSP_HCM401K_COMPANY_POLICY ADD PRIMARY KEY (HCM401K_COMPANY_POLICY_SEQ, REALM_ID) USING INDEX;
/
ALTER TABLE PSP_HCM401K_COMPANY_QBDT_PITEM ADD PRIMARY KEY (HCM401K_COMPANY_QBDT_PITEM_SEQ, REALM_ID) USING INDEX;
/
ALTER TABLE PSP_HCM401K_EMPLOYEE_DEDUCTION ADD PRIMARY KEY (HCM401K_EMPLOYEE_DEDUCTION_SEQ, REALM_ID) USING INDEX;
