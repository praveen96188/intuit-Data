 ...
 */
public class UpdateCompanyPINCore extends Process implements IProcess {

    /**
     * Core process for updating a company's PIN in order to allow a
     * connection to PSP.
     *
    ...
    public UpdateCompanyPINCore(SourceSystemCode pSourceSystemCd, String pSourceCompanyId,
                                String pPIN) {
