 ...
 */
public class RemoveUserAuthorizationTokenCore extends Process implements IProcess {

    private AuthUser mUser;
    private String mCorpId;

    public RemoveUserAuthorizationTokenCore(String pCorpId) {
