 ...
 */
package psp.taxcredits.swfaddress{
    ...
    import psp.taxcredits.swfaddress.SWFAddressEvent;

    /**
     * Dispatched when <code>SWFAddress</code> initializes.
     */
    [Event(name='init', type='psp.taxcredits.swfaddress.SWFAddressEvent')]
    /**
     * Dispatched when any value change.
     */
    [Event(name='change', type='psp.taxcredits.swfaddress.SWFAddressEvent')]
    /**
     * Dispatched when value was changed by Flash.
     */
    [Event(name='internalChange', type='psp.taxcredits.swfaddress.SWFAddressEvent')]
    /**
     * Dispatched when value was changed by Browser.
     */
    [Event(name='externalChange', type='psp.taxcredits.swfaddress.SWFAddressEvent')]
