...
@Configuration
@Component
public class EmailConfigOverride {
    @Bean
    public EmailSettings emailSettings() {
        ...
        int postRetryCount = Integer.parseInt(ConfigurationManager.getSettingValue(ConfigurationModule.EmailGateway, "psp_email_txe_retry_count"));
        int postRetryIntervalExponential = Integer.parseInt(ConfigurationManager.getSettingValue(ConfigurationModule.EmailGateway, "psp_email_txe_retry_intervalexp"));
