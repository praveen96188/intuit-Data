...
public class SimpleFtpsFile {
     ...
     * @param pPassword
     */
    public SimpleFtpsFile(String pHost, String pUsername, String pPassword) {
        mFtps = new Ftps(pHost, pUsername, pPassword);
    ...
    public void setDebugMode() {
        ...
        String debugFileName = "ftpsdebug-" + sdf.format(new Date()) + ".log";
        ...
        try {
            ...
            mFtps.setDebugStream(new PrintStream(ftpDebugFile));
        } catch (Exception e) {
            getLogger().warn("Error setting FTPS debug stream to file, using stdout.", e);
        } finally {
            mFtps.setDebug(true);
    ...
    public void setProxyHost(String pProxyHostname, int pProxyPort) {
        mFtps.setProxyHost(pProxyHostname, pProxyPort);
    }
    ...
    public void setProxyAuthentication(String pProxyUsername, String pProxyPassword) {
        mFtps.setProxyAuthentication(pProxyUsername, pProxyPassword);
    }
    ...
    public void setConnectionTimeout(int pTimeoutMillis) {
        mFtps.setTimeout(pTimeoutMillis);
    }
    ...
    public void addListener(FtpListener pListener) {
        if (pListener != null) {
            mFtps.addFtpListener(pListener);
        }
    }

    public int getPort() {
        return mFtps.getPort();
    }
    ...
    public boolean getUseEPSV() {
        return mFtps.getUseEPSV();
    }

    public void setUseEPSV(boolean pUseEPSV) {
        mFtps.setUseEPSV(pUseEPSV);
    }
    ...
    public void setAscii() {
        try {
            ...
            throw new RuntimeException("Failed to change to ASCII mode. ", e);
        }
    }
    ...
    public void setBinary() {
        try {
            ...
            throw new RuntimeException("Failed to change to BINARY mode. ", e);
        }
    }
    ...
    public void changeLocalDir(String pDir) {
        if (pDir != null) {
            try {
                mFtps.setLocalDir(new File(pDir));
            } catch (Exception e) {
    ...
    public void uploadFile(String pLocalFile, String pRemoteFile) {
        ...
        if (pLocalFile != null) {
            try {
                mFtps.upload(pLocalFile, pRemoteFile);
            } catch (FtpException e) {
    ...
    public Enumeration getRemoteDirListing(String pRegex) {
        ...
        try {
            listing = mFtps.getDirListing(pRegex);
        } catch (FtpException e) {
    ...
    public void renameRemoteFile(String pOldFile, String pNewFile) {
        try {
            mFtps.renameFile(pOldFile, pNewFile);
        } catch (FtpException e) {
