...
public class SpcfLittleEndianBitConverter extends SpcfBitConverter
{
	public SpcfLittleEndianBitConverter()
	{
		super();
	}
	...
	{
		return SpcfByteOrderEnum.LittleEndian;
	}
	...
	public char toChar(byte[] buffer)
	{
		...
		return (char)((buffer[1] << 8) | (buffer[0] & 0xff));
	}
	...
	public byte[] fromChar(char c)
	{
		...
		buffer[1] = (byte)(0xff & (c >> 8));
		buffer[0] = (byte)(0xff & c);
		return buffer;
	}
	...
	public byte[] fromInt(int i)
	{
		...
		buffer[3] = (byte)(0xff & (i >> 24));
		buffer[2] = (byte)(0xff & (i >> 16));
		buffer[1] = (byte)(0xff & (i >> 8));
	...
	public byte[] fromLong(long l)
	{
		...
		buffer[7] = (byte)(0xff & (l >> 56));
		buffer[6] = (byte)(0xff & (l >> 48));
		buffer[5] = (byte)(0xff & (l >> 40));
		buffer[4] = (byte)(0xff & (l >> 32));
		buffer[3] = (byte)(0xff & (l >> 24));
		buffer[2] = (byte)(0xff & (l >> 16));
		buffer[1] = (byte)(0xff & (l >>  8));
		buffer[0] = (byte)(0xff &  l);
		return buffer;
	}
	...
	{
		byte[] buffer = new byte[2];
		buffer[1] = (byte)(0xff & (s >> 8));
		buffer[0] = (byte)(0xff &  s);
		return buffer;
	}
}
