...
//AN public final class MathContext implements java.io.Serializable{
/**
 * Class used internally for SpcfDecimal 
 */
final class MathContext implements java.io.Serializable{
  ...
  * @stable ICU 2.0
  */
 public static final MathContext DEFAULT=new MathContext(DEFAULT_DIGITS,DEFAULT_FORM,DEFAULT_LOSTDIGITS,DEFAULT_ROUNDINGMODE);
