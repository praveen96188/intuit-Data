...
/**
 * Georgia withholding for TXP output
 */
public class Txp_GA_WH extends TxpRecordManager {
    public Txp_GA_WH() {
        super("/pay-def-ga.xml");
    }
    ...
    public void createTxpRecord(EntryDetailRecord pEdr) {
        getTxpTemplate().setFieldValue(FieldId.TAXPAYER_EIN, getAgencyId(pEdr).toUpperCase());
