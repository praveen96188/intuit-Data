...
/**
 * Virginia withholding for TXP output
 */
public class Txp_VA_WH extends TxpRecordManager {
    public Txp_VA_WH() {
        super("/pay-def-va.xml");
    }
    ...
    public void createTxpRecord(EntryDetailRecord pEdr) {
        getTxpTemplate().setFieldValue(FieldId.TAXPAYER_EIN2, getWithoutHyphens(getAgencyId(pEdr)));
