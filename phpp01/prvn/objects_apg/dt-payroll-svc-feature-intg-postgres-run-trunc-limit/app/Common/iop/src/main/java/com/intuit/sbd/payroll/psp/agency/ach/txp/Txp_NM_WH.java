...
/**
 * New Mexico withholding for TXP output
 */
public class Txp_NM_WH extends TxpRecordManager {
    public Txp_NM_WH() {
        super("/pay-def-nm.xml");
    }
    ...
    public void createTxpRecord(EntryDetailRecord pEdr) {
        ...
        getTxpTemplate().setFieldValue(FieldId.REPORT_DATE, getFullEndDate(pEdr));
