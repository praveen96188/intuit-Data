...
package com.paycycle.eftps;

public class EftpsRuntimeException extends RuntimeException {
    public EftpsRuntimeException(String message) {
        super(message);
    }

    public EftpsRuntimeException(String message, Throwable cause) {
        super(message, cause);
    }
}	
