/*
 * $Id: //psp/dev/Common/TestUtils/src/com/intuit/sbd/payroll/psp/processes/dataloaders/Company401kDataloader.java#2 $
 *
...
public class Company401kDataloader {
    ...
    public Company persistCompanyButNotEmployee() {
        ...
        ProcessResult<Company> result = PayrollServices.companyManager.addCompany(getCompany1());
