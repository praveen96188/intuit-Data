 ...
 * Time: 11:30 AM
 */
public class PgpEncryptedReader implements PgpReader {
    ...
    private static final SpcfLogger logger = SpcfLogManager.getLogger(PgpEncryptedReader.class);
    ...
    private void readParameters() {
        mSkipSignatureVerification = SystemParameter.findBooleanValue(SystemParameter.Code.JPMC_SKIP_SIGNATURE_VERIFICATION, false);
