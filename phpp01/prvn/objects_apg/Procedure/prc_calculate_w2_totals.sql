    ...
    BEGIN
        ...
        IF p_company_id is null
            THEN
                ...
                FROM ( SELECT DISTINCT company_fk
                       FROM
                           (SELECT distinct company_fk  as company_fk from PSP_EMPLOYEE_LAW_QTR_TOTALS WHERE year = p_processing_year
                            ...
                            WHERE PIT.YEAR = p_processing_year) as PELQTcfpccf ) as PELQTcfpccfcf;

                DECLARE
                psp_employee_w2_totals_cursor_c1 CURSOR FOR
                ...
                FOR cursor_rec in psp_employee_w2_totals_cursor_c1

                LOOP

                UPDATE psp_employee_w2_totals
                                   SET amount =  cursor_rec.amount,
                                      taxable_wages = cursor_rec.taxable_wages,
                                      tips_taxable_wages_amount = cursor_rec.tips_taxable_wages_amount,
                                      total_wages = cursor_rec.total_wages,
                                      modified_date = v_utc_date,
                                      version = version+1,
                                      modifier_id='W2ANNUALCALCULATIONUPD'

                                   where company_fk = cursor_rec.company_fk
                                    AND employee_fk = cursor_rec.employee_fk
                                    AND company_law_fk = cursor_rec.company_law_fk
                                    AND year =  p_processing_year;

                GET DIAGNOSTICS total_rows := ROW_COUNT;

                IF total_rows = 0 THEN

                    INSERT INTO psp_employee_w2_totals (EMPLOYEE_W2_TOTALS_SEQ, VERSION, CREATOR_ID,
                            CREATED_DATE, MODIFIER_ID, MODIFIED_DATE,
                    ...
                    VALUES (
                           gen_random_uuid(),
                            ...
                            p_processing_year, cursor_rec.taxable_wages,
                            cursor_rec.amount, cursor_rec.tips_taxable_wages_amount,
                            cursor_rec.total_wages,
                            null, cursor_rec.employee_fk, cursor_rec.law_fk,
                            cursor_rec.company_fk, cursor_rec.company_law_fk
                       );
                ...
                psp_employee_w2_totals_cursor_c2 CURSOR FOR
                ...
                FOR cursor_rec in psp_employee_w2_totals_cursor_c2
                ...
                UPDATE psp_employee_w2_totals
                    ...
                    WHERE company_fk = cursor_rec.company_fk
                    AND employee_fk = cursor_rec.employee_fk
                    AND company_payroll_item_fk = cursor_rec.company_payroll_item_fk
                    AND year =  p_processing_year;
                ...
                VALUES (
                        ...
                        cursor_rec.amount, cursor_rec.tips_taxable_wages_amount,
                        cursor_rec.total_wages,
                        cursor_rec.company_payroll_item_fk, cursor_rec.employee_fk, null,
                        cursor_rec.company_fk, null
                       );
            ...
            ELSE  -- Calculate for one company
                ...
                psp_employee_w2_totals_cursor_c3 CURSOR FOR
                ...
                FOR cursor_rec in psp_employee_w2_totals_cursor_c3
                ...
                psp_employee_w2_totals_c4 CURSOR FOR
                    SELECT cpi.COMPANY_FK as company_fk,  EMPLOYEE_FK, COMPANY_PAYROLL_ITEM_FK,
                    SUM(TAXABLE_WAGES) as taxable_wages,
                    SUM(AMOUNT) as amount,
                    SUM(TIPS_TAXABLE_WAGES_AMOUNT) as tips_taxable_wages_amount,
                ...
                BEGIN
                    ...
                    FOR cursor_rec IN psp_employee_w2_totals_c4
