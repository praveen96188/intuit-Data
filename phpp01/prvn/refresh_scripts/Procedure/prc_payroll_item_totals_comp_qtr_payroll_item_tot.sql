...
******************************************/
CREATE OR REPLACE PROCEDURE prc_payroll_item_totals_comp_qtr_payroll_item_tot (
    p_company_seq               IN   VARCHAR, -- Company seq
...
select gen_random_uuid(), 1, 'PK_PAYROLL_ITEM_TOTALS', v_utc_date,
