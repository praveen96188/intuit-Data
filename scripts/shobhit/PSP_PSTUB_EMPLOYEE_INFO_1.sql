...
DECLARE
    ...
    START_DATE         DATE := TO_DATE('2011-01-01', 'yyyy-mm-dd');
    END_DATE           DATE := TO_DATE('2017-08-01', 'yyyy-mm-dd');
            ...
            WHILE (BATCH_COUNT > 0 AND PROCESSED_RECORDS < MAX_RECORDS)
                ...
                LOOP
                    BEGIN
                        ...
                        set Total_processed = PROCESSED_RECORDS
                        where table_name ='PSP_PSTUB_EMPLOYEE_INFO_1';
