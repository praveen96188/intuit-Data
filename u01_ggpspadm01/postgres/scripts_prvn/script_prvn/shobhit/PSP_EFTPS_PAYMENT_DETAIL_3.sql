SET PAGESIZE 50000
SPOOL PSP_EFTPS_PAYMENT_DETAIL_3
SET SERVEROUTPUT ON;
SET TIMING ON;
...
DECLARE
    ...
    START_DATE         DATE := TO_DATE('2016-06-01', 'yyyy-mm-dd');
    END_DATE           DATE := TO_DATE('2019-07-01', 'yyyy-mm-dd');
            ...
            WHILE (BATCH_COUNT > 0 AND PROCESSED_RECORDS < MAX_RECORDS)
                ...
                LOOP
                    BEGIN
                        ...
                        UPDATE SKUMAR71.TEMP_DATA_POPULATION T1 SET T1.Total_processed = PROCESSED_RECORDS WHERE T1.table_name ='PSP_EFTPS_PAYMENT_DETAIL_062016_062019';
                        commit;
