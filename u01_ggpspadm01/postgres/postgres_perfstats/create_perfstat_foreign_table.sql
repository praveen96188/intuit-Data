\prompt 'Enter postgresfdw password: ' postgresfdw_password
...
ALTER ROLE postgresfdw PASSWORD :'postgresfdw_password';
...
create user mapping if not exists for public server :reader_instance_name_us options (user 'postgresfdw', password :'postgresfdw_password');
...
-- Create user mapping for postgresfdw
create user mapping for public server :writer_instance_name_us options (user 'postgresfdw', password :'postgresfdw_password');
