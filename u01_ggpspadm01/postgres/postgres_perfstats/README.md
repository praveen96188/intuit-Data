...
* [Deployment](#deployment)
    ...
    - [Setup for cross-region DR](#Setup-for-cross-region-DR)
...
### Setup for cross-region DR
In order to collect statistics after cross-region switchover or failover, you need to go through all steps above except Create perfstat schema and Create db user for the DR region.  
