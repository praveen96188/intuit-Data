...
alter table perfstat.pg_stat_statements_hist add constraint pg_stat_statements_hist_pk primary key (snap_id, snap_time, userid, dbid, queryid, toplevel, instance_name);
