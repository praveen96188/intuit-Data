...
CREATE TABLE psparc.arch_purge_main_stats_list(
...
CREATE TABLE psparc.payroll_hist(
...
CREATE TABLE psparc.psp_accounting_report_file(
...
CREATE TABLE psparc.psp_ach_transaction_code(
...
CREATE TABLE psparc.psp_achenrollment(
...
CREATE TABLE psparc.psp_achenrollment_detail(
...
CREATE TABLE psparc.psp_achenrollment_file(
...
CREATE TABLE psparc.psp_action_event(
...
CREATE TABLE psparc.psp_additional_filing_amount(
...
CREATE TABLE psparc.psp_address(
...
CREATE TABLE psparc.psp_ade_law_map(
...
CREATE TABLE psparc.psp_agency(
...
CREATE TABLE psparc.psp_agency_check_batch(
...
CREATE TABLE psparc.psp_agency_id_requirement(
...
CREATE TABLE psparc.psp_agency_rate_request(
...
CREATE TABLE psparc.psp_annual_billing_batch(
...
CREATE TABLE psparc.psp_annual_billing_item(
...
CREATE TABLE psparc.psp_applied_database_patch(
...
CREATE TABLE psparc.psp_archive_record(
...
CREATE TABLE psparc.psp_assisted_bundle_bill(
...
CREATE TABLE psparc.psp_asst_bundle_bill_detail(
...
CREATE TABLE psparc.psp_asst_bundle_comp_usage(
...
CREATE TABLE psparc.psp_atfdata_extract_batch(
...
CREATE TABLE psparc.psp_atfdata_extract_file(
...
CREATE TABLE psparc.psp_atfpayments_to_process(
...
CREATE TABLE psparc.psp_atfpayrolls_to_process(
...
CREATE TABLE psparc.psp_auth_domain(
...
CREATE TABLE psparc.psp_auth_operation(
...
CREATE TABLE psparc.psp_auth_role(
...
CREATE TABLE psparc.psp_auth_user(
...
CREATE TABLE psparc.psp_auth_user_auth_role__assoc(
...
CREATE TABLE psparc.psp_authrole_operation_assoc(
    auth_role_fk CHARACTER VARYING(255) NOT NULL,
    auth_operation_fk CHARACTER VARYING(255) NOT NULL,
    realm_id smallint NOT NULL DEFAULT - 1
);

CREATE TABLE psparc.psp_bank_account(
...
CREATE TABLE psparc.psp_bank_holiday(
...
CREATE TABLE psparc.psp_batch_job_audit_log(
...
CREATE TABLE psparc.psp_batch_job_parameter(
...
CREATE TABLE psparc.psp_batch_job_setup(
...
CREATE TABLE psparc.psp_batch_job_status(
...
CREATE TABLE psparc.psp_bill_payment(
...
CREATE TABLE psparc.psp_bill_payment_split(
...
CREATE TABLE psparc.psp_billing_detail(
...
CREATE TABLE psparc.psp_bpcompany_service_info(
...
CREATE TABLE psparc.psp_cdcompany_service_info(
    cdcompany_service_info_seq CHARACTER VARYING(255) NOT NULL,
    realm_id SMALLINT NOT NULL DEFAULT - 1,
    last_paycheck_id integer
);

CREATE TABLE psparc.psp_check_print_batch(
...
CREATE TABLE psparc.psp_check_print_paycheck(
...
CREATE TABLE psparc.psp_check_print_signature(
...
CREATE TABLE psparc.psp_collection_stage(
...
CREATE TABLE psparc.psp_comp_adjust_submission(
...
CREATE TABLE psparc.psp_comp_pmt_template_agencyid(
...
CREATE TABLE psparc.psp_comp_pmttemplate_pmtmethod(
...
CREATE TABLE psparc.psp_company(
...
CREATE TABLE psparc.psp_company_additional_info(
...
CREATE TABLE psparc.psp_company_agency(
...
CREATE TABLE psparc.psp_company_bank_account(
...
CREATE TABLE psparc.psp_company_consent(
...
CREATE TABLE psparc.psp_company_daily_liability(
...
CREATE TABLE psparc.psp_company_event_email(
...
CREATE TABLE psparc.psp_company_filing_amount(
...
CREATE TABLE psparc.psp_company_law(
...
CREATE TABLE psparc.psp_company_law_rate(
...
CREATE TABLE psparc.psp_company_note(
...
CREATE TABLE psparc.psp_company_offer(
...
CREATE TABLE psparc.psp_company_offering(
...
CREATE TABLE psparc.psp_company_paycheck_batch(
...
CREATE TABLE psparc.psp_company_payroll_item(
...
CREATE TABLE psparc.psp_company_pin(
...
CREATE TABLE psparc.psp_company_rate_request(
...
CREATE TABLE psparc.psp_company_service(
...
CREATE TABLE psparc.psp_company_service_bank_acct(
...
CREATE TABLE psparc.psp_company_tfssubmission(
...
CREATE TABLE psparc.psp_company_usage(
...
CREATE TABLE psparc.psp_companyagency_frmtemplate(
...
CREATE TABLE psparc.psp_companyagency_pmttemplate(
...
CREATE TABLE psparc.psp_contact(
...
CREATE TABLE psparc.psp_ddcompany_service_info(
...
CREATE TABLE psparc.psp_deleted_record(
...
CREATE TABLE psparc.psp_deposit_frequency_file(
...
CREATE TABLE psparc.psp_deposit_frequency_file_rec(
...
CREATE TABLE psparc.psp_disburse_advice(
...
CREATE TABLE psparc.psp_edi_payment_detail(
...
CREATE TABLE psparc.psp_edi_tax_file(
...
CREATE TABLE psparc.psp_ee_payrollitem_qtrtotals(
...
CREATE TABLE psparc.psp_effective_deposit_freq(
...
CREATE TABLE psparc.psp_eftps_enrollment(
...
CREATE TABLE psparc.psp_eftps_enrollment_detail(
...
CREATE TABLE psparc.psp_eftps_file(
...
CREATE TABLE psparc.psp_eftps_payment_detail(
...
CREATE TABLE psparc.psp_emp_totals_payroll_run(
...
CREATE TABLE psparc.psp_employee(
...
CREATE TABLE psparc.psp_employee_accrual(
...
CREATE TABLE psparc.psp_employee_bank_account(
...
CREATE TABLE psparc.psp_employee_custom_field(
...
CREATE TABLE psparc.psp_employee_law_qtr_totals(
...
CREATE TABLE psparc.psp_employee_payroll_item(
...
CREATE TABLE psparc.psp_employee_tax(
...
CREATE TABLE psparc.psp_employee_usage(
...
CREATE TABLE psparc.psp_employee_w2_totals(
...
CREATE TABLE psparc.psp_employee_wage_plan(
...
CREATE TABLE psparc.psp_employer_contribution(
...
CREATE TABLE psparc.psp_employer_preference(
...
CREATE TABLE psparc.psp_entitlement(
...
CREATE TABLE psparc.psp_entitlement_code(
...
CREATE TABLE psparc.psp_entitlement_code_offering(
...
CREATE TABLE psparc.psp_entitlement_unit(
...
CREATE TABLE psparc.psp_entity_change(
...
CREATE TABLE psparc.psp_event_as400_sync(
...
CREATE TABLE psparc.psp_event_detail_type(
...
CREATE TABLE psparc.psp_event_log(
...
CREATE TABLE psparc.psp_event_type(
...
CREATE TABLE psparc.psp_financial_txn_action(
...
CREATE TABLE psparc.psp_fintxn_onholdreason_assoc(
...
CREATE TABLE psparc.psp_forecast(
...
CREATE TABLE psparc.psp_forecast_detail(
...
CREATE TABLE psparc.psp_form_template(
...
CREATE TABLE psparc.psp_fraud_address(
...
CREATE TABLE psparc.psp_fraud_bank_account(
...
CREATE TABLE psparc.psp_fraud_company(
...
CREATE TABLE psparc.psp_fraud_contact(
...
CREATE TABLE psparc.psp_fraud_event(
...
CREATE TABLE psparc.psp_fraud_rule(
...
CREATE TABLE psparc.psp_fraud_value(
...
CREATE TABLE psparc.psp_fset_file(
...
CREATE TABLE psparc.psp_fset_filing_detail(
...
CREATE TABLE psparc.psp_funding_model(
...
CREATE TABLE psparc.psp_gems_ledger_posting_rule(
...
CREATE TABLE psparc.psp_gems_monthly_balance(
...
CREATE TABLE psparc.psp_gems_upload_batch(
...
CREATE TABLE psparc.psp_hours_worked_exception(
...
CREATE TABLE psparc.psp_individual(
...
CREATE TABLE psparc.psp_industry_type(
...
CREATE TABLE psparc.psp_intuit_ba_bt_ft(
...
CREATE TABLE psparc.psp_intuit_bank_acc_txn_type(
...
CREATE TABLE psparc.psp_intuit_bank_account(
...
CREATE TABLE psparc.psp_intuit_shipper_info(
...
CREATE TABLE psparc.psp_iopsync_company(
...
CREATE TABLE psparc.psp_law_rate_range(
...
CREATE TABLE psparc.psp_law_rate_value(
...
CREATE TABLE psparc.psp_ledger_account(
...
CREATE TABLE psparc.psp_ledger_account_action(
...
CREATE TABLE psparc.psp_ledger_operation(
...
CREATE TABLE psparc.psp_ledger_operation_job(
...
CREATE TABLE psparc.psp_liab_check_billing_assoc(
...
CREATE TABLE psparc.psp_liability_adjustment(
...
CREATE TABLE psparc.psp_liability_check(
...
CREATE TABLE psparc.psp_liability_check_line(
...
CREATE TABLE psparc.psp_limit_rule(
...
CREATE TABLE psparc.psp_limit_value(
...
CREATE TABLE psparc.psp_manual_requirement(
    manual_requirement_seq CHARACTER VARYING(255) NOT NULL,
    realm_id smallint NOT NULL DEFAULT - 1
);

CREATE TABLE psparc.psp_message_log(
...
CREATE TABLE psparc.psp_nachafile(
...
CREATE TABLE psparc.psp_offer_price(
...
CREATE TABLE psparc.psp_offer_svcchg_assoc(
    offer_fk CHARACTER VARYING(255) NOT NULL,
    offering_service_charge_fk CHARACTER VARYING(255) NOT NULL,
    realm_id smallint NOT NULL DEFAULT - 1
);

CREATE TABLE psparc.psp_offering(
...
CREATE TABLE psparc.psp_offering_svcchg(
...
CREATE TABLE psparc.psp_offering_svcchg_grp(
...
CREATE TABLE psparc.psp_offload_batch(
...
CREATE TABLE psparc.psp_offload_group(
...
CREATE TABLE psparc.psp_on_hold_reason(
...
CREATE TABLE psparc.psp_ownership_type(
...
CREATE TABLE psparc.psp_pay_item(
...
CREATE TABLE psparc.psp_paycheck_usage_hist(
...
CREATE TABLE psparc.psp_payee_bank_account(
...
CREATE TABLE psparc.psp_payment_batch_assoc(
...
CREATE TABLE psparc.psp_payment_method_requirement(
...
CREATE TABLE psparc.psp_payment_requirement(
    payment_requirement_seq CHARACTER VARYING(255) NOT NULL,
    realm_id smallint NOT NULL DEFAULT - 1
);

CREATE TABLE psparc.psp_payment_template(
...
CREATE TABLE psparc.psp_payment_template_agency_id(
...
CREATE TABLE psparc.psp_payroll_fraud_batch(
...
CREATE TABLE psparc.psp_payroll_frequency(
...
CREATE TABLE psparc.psp_payroll_item(
...
CREATE TABLE psparc.psp_payroll_item_taxable_to(
...
CREATE TABLE psparc.psp_payroll_run(
...
CREATE TABLE psparc.psp_payroll_run_action(
...
CREATE TABLE psparc.psp_payroll_subtype(
...
CREATE TABLE psparc.psp_pmt_template_bankaccount(
...
CREATE TABLE psparc.psp_pmt_template_frequency(
...
CREATE TABLE psparc.psp_pmt_template_paymentmethod(
...
CREATE TABLE psparc.psp_pmttemplate_chkinfo_assoc(
...
CREATE TABLE psparc.psp_pmttemplate_printedchkinfo(
...
CREATE TABLE psparc.psp_posting_rule(
...
CREATE TABLE psparc.psp_posting_rule_mar7(
    posting_rule_cd CHARACTER VARYING(40) NOT NULL,
    version integer NOT NULL,
    realm_id SMALLINT NOT NULL DEFAULT - 1,
    credit_debit_ind CHARACTER VARYING(10),
...
CREATE TABLE psparc.psp_prior_payment_submission(
...
CREATE TABLE psparc.psp_pstub_address(
...
CREATE TABLE psparc.psp_pstub_dditem(
...
CREATE TABLE psparc.psp_pstub_employee_preference(
...
CREATE TABLE psparc.psp_pstub_employer_info(
...
CREATE TABLE psparc.psp_pstub_msg(
...
CREATE TABLE psparc.psp_pstub_state_tax_info(
...
CREATE TABLE psparc.psp_qbdt_employee_info(
...
CREATE TABLE psparc.psp_qbdt_payroll_item_info(
...
CREATE TABLE psparc.psp_qbdt_payroll_trans_line(
...
CREATE TABLE psparc.psp_qbdt_payroll_transaction(
...
CREATE TABLE psparc.psp_qbdt_unprocessed_request(
...
CREATE TABLE psparc.psp_quickbooks_info(
...
CREATE TABLE psparc.psp_racompany_service_info(
    racompany_service_info_seq CHARACTER VARYING(255) NOT NULL,
    realm_id SMALLINT NOT NULL DEFAULT - 1,
    override_company_limit_amount NUMERIC(19,4)
);

CREATE TABLE psparc.psp_rafenrollment(
...
CREATE TABLE psparc.psp_rafenrollment_detail(
...
CREATE TABLE psparc.psp_rafenrollment_file(
...
CREATE TABLE psparc.psp_rate_ledger_operation(
...
CREATE TABLE psparc.psp_report_job_setup(
...
CREATE TABLE psparc.psp_reporting_agent(
...
CREATE TABLE psparc.psp_return_reason_desc(
...
CREATE TABLE psparc.psp_role_sub_status(
...
CREATE TABLE psparc.psp_rpt_paid_employees(
...
CREATE TABLE psparc.psp_rtbautomationbackup(
...
CREATE TABLE psparc.psp_saved_reports(
...
CREATE TABLE psparc.psp_second_offload(
...
CREATE TABLE psparc.psp_serv_stat_txn_sku_type(
...
CREATE TABLE psparc.psp_service(
...
CREATE TABLE psparc.psp_service_status(
...
CREATE TABLE psparc.psp_service_sub_status(
...
CREATE TABLE psparc.psp_smsmigration(
...
CREATE TABLE psparc.psp_smssync_failure(
...
CREATE TABLE psparc.psp_source_payroll_parameter(
...
CREATE TABLE psparc.psp_source_system(
...
CREATE TABLE psparc.psp_source_system_law_assoc(
...
CREATE TABLE psparc.psp_sourcesys_printedchk_info(
...
CREATE TABLE psparc.psp_sql_execution_log_entry(
...
CREATE TABLE psparc.psp_state_edi_tax_file(
    state_edi_tax_file_seq CHARACTER VARYING(255) NOT NULL,
    realm_id SMALLINT NOT NULL DEFAULT - 1,
    ack_file_fk CHARACTER VARYING(255)
);

CREATE TABLE psparc.psp_state_report_assoc(
...
CREATE TABLE psparc.psp_state_report_output(
...
CREATE TABLE psparc.psp_suicredits_job(
...
CREATE TABLE psparc.psp_svcchgprice(
...
CREATE TABLE psparc.psp_svcstat_srcsys_assoc(
    service_sub_status_fk CHARACTER VARYING(255) NOT NULL,
    source_system_fk CHARACTER VARYING(255) NOT NULL,
    realm_id smallint NOT NULL DEFAULT - 1
);

CREATE TABLE psparc.psp_svcstat_svc_assoc(
    service_sub_status_fk CHARACTER VARYING(255) NOT NULL,
    service_fk CHARACTER VARYING(255) NOT NULL,
    realm_id smallint NOT NULL DEFAULT - 1
);

CREATE TABLE psparc.psp_svcstat_syscap_assoc(
    service_sub_status_fk CHARACTER VARYING(255) NOT NULL,
    system_capability_fk CHARACTER VARYING(255) NOT NULL,
    realm_id smallint NOT NULL DEFAULT - 1
);

CREATE TABLE psparc.psp_system_capability(
...
CREATE TABLE psparc.psp_system_parameter(
...
CREATE TABLE psparc.psp_tax_company_service_info(
...
CREATE TABLE psparc.psp_tax_credits9061(
...
CREATE TABLE psparc.psp_tax_credits_application(
...
CREATE TABLE psparc.psp_tax_payment_on_hold_reason(
...
CREATE TABLE psparc.psp_tax_penalty_interest(
...
CREATE TABLE psparc.psp_tax_table_misc_data(
...
CREATE TABLE psparc.psp_third_party401k_batch(
...
CREATE TABLE psparc.psp_tp401k_batch_paycheck(
...
CREATE TABLE psparc.psp_tp401k_paycheck(
...
CREATE TABLE psparc.psp_tp401k_paycheck_pending(
...
CREATE TABLE psparc.psp_tp401k_paycheck_state(
...
CREATE TABLE psparc.psp_tp401k_signup_batch(
...
CREATE TABLE psparc.psp_tp401k_signup_queue(
...
CREATE TABLE psparc.psp_tp401kcompany_service_info(
...
CREATE TABLE psparc.psp_transaction_offload_batch(
...
CREATE TABLE psparc.psp_transaction_response(
...
CREATE TABLE psparc.psp_transaction_return(
...
CREATE TABLE psparc.psp_transaction_return_batch(
...
CREATE TABLE psparc.psp_transaction_state(
...
CREATE TABLE psparc.psp_transaction_type(
...
CREATE TABLE psparc.psp_transaction_type_mar7(
    transaction_type_cd CHARACTER VARYING(255) NOT NULL,
    version integer NOT NULL,
    realm_id SMALLINT NOT NULL DEFAULT - 1,
    description CHARACTER VARYING(160),
...
CREATE TABLE psparc.psp_transmission_payroll_run(
...
CREATE TABLE psparc.psp_txntype_service_assoc(
    transaction_type_fk CHARACTER VARYING(255) NOT NULL,
    service_fk CHARACTER VARYING(255) NOT NULL,
    realm_id smallint NOT NULL DEFAULT - 1
);

CREATE TABLE psparc.psp_usage_period(
...
CREATE TABLE psparc.psp_user_preference(
...
CREATE TABLE psparc.psp_user_setting(
...
CREATE TABLE psparc.psp_vmp_employee_info(
...
CREATE TABLE psparc.psp_voided_check(
...
CREATE TABLE psparc.psp_wage_limit(
...
CREATE TABLE psparc.psp_wc_company(
...
CREATE TABLE psparc.psp_wc_paycheck(
...
CREATE TABLE psparc.psp_wc_paycheck_pending(
...
CREATE TABLE psparc.psp_wc_paycheck_state(
...
CREATE TABLE psparc.psp_entry_detail_record_staging(
    company_fk CHARACTER VARYING(255) NOT NULL,
...
CREATE TABLE psparc.psp_hcm401k_company_policy(
...
CREATE TABLE psparc.psp_hcm401k_company_qbdt_pitem(
...
CREATE TABLE psparc.psp_hcm401k_employee_deduction(
...
CREATE TABLE psparc.psp_hcm401k_policy(
