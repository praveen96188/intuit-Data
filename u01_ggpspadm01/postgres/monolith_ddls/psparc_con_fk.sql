...
--Not creating this FK as planning to not copy the psp_ledger_operation_job table. To do so we will have to disable this constraint
...
ALTER TABLE psparc.psp_hcm401k_company_policy ADD CONSTRAINT psp_hcm401k_company_policy_fk1 FOREIGN KEY (hcm401k_policy_fk, realm_id) REFERENCES psparc.psp_hcm401k_policy (hcm401k_policy_seq, realm_id);
ALTER TABLE psparc.psp_hcm401k_company_qbdt_pitem ADD CONSTRAINT psp_hcm401k_company_qbdt_p_fk1 FOREIGN KEY (hcm401k_company_policy_fk, realm_id) REFERENCES psparc.psp_hcm401k_company_policy (hcm401k_company_policy_seq, realm_id);
ALTER TABLE psparc.psp_hcm401k_employee_deduction ADD CONSTRAINT psp_hcm401k_employee_deduc_fk1 FOREIGN KEY (hcm401k_company_policy_fk, realm_id) REFERENCES psparc.psp_hcm401k_company_policy (hcm401k_company_policy_seq, realm_id);
