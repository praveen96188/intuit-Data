...
spool run_fs_tab_pc
select /*+ FULL(PAYCHECK_BA12023) parallel(PAYCHECK_BA12023 ,4) */count(*) from pspadm.PSP_PAYCHECK partition (PAYCHECK_BA12023)PAYCHECK_BA12023 ;
select /*+ FULL(PAYCHECK_BA22023) parallel(PAYCHECK_BA22023 ,4) */count(*) from pspadm.PSP_PAYCHECK partition (PAYCHECK_BA22023)PAYCHECK_BA22023 ;
