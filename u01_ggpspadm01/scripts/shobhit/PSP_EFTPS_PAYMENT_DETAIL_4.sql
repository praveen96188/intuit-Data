            ...
            WHILE (BATCH_COUNT > 0 AND PROCESSED_RECORDS < MAX_RECORDS)
                ...
                LOOP
                    BEGIN
                        ...
                        UPDATE SKUMAR71.TEMP_DATA_POPULATION T1 SET T1.Total_processed = PROCESSED_RECORDS WHERE T1.table_name ='PSP_EFTPS_PAYMENT_DETAIL_072019_032023';
                        commit;
