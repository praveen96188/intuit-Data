...
DECLARE
    ...
    PROCESSED_RECORDS  INTEGER   := 4372098;
    ERROR_RECORDS      INTEGER   := 0;
    MAX_FETCH_RECORDS  INTEGER   := 10000;
    BATCH_COUNT        INTEGER   := 0;
    START_DATE         DATE := TO_DATE('2011-09-01', 'yyyy-mm-dd');
    END_DATE           DATE := TO_DATE('2011-12-01', 'yyyy-mm-dd');
            ...
            WHILE (BATCH_COUNT > 0 AND PROCESSED_RECORDS < MAX_RECORDS)
                ...
                LOOP
                    BEGIN
                        ...
                        WHERE T1.table_name ='PSP_EFTPS_PAYMENT_DETAIL_1';
                        COMMIT; 
