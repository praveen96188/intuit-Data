...
select segment_name, segment_type, partition_name, tablespace_name from dba_segments where owner = 'IBOBADM' and segment_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION' and partition_name like 'SRCSYSTRNS_M%2021%' order by partition_name;
...
select table_name, partition_name, high_value, tablespace_name from dba_tab_partitions where table_owner = 'IBOBADM' and table_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION' and partition_name like 'SRCSYSTRNS_M%2021%' order by partition_position;
select table_name, subpartition_name, high_value, tablespace_name from dba_tab_subpartitions where table_owner = 'IBOBADM' and table_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION' and partition_name like 'SRCSYSTRNS_M%2021%' order by partition_name, subpartition_position;
...
select table_name, column_name, lob_name, partition_name, lob_partition_name, lob_indpart_name from dba_lob_partitions where table_owner = 'IBOBADM' and table_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION' and partition_name like 'SRCSYSTRNS_M%2021%' order by partition_position;
