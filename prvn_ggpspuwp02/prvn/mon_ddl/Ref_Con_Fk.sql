...
--------------------------------------------------------
--  ref constraints for table psp_fintxn_onholdreason_assoc
--------------------------------------------------------

--alter table pspadm.psp_fintxn_onholdreason_assoc add constraint psp_fin_txn_hold_fk_fin_txn foreign key (company_fk,financial_transaction_fk) references pspadm.psp_financial_transaction (company_fk,financial_transaction_seq) ON DELETE NO ACTION ;

--alter table pspadm.psp_fintxn_onholdreason_assoc add constraint psp_fin_txn_hold_fk_fin_txn foreign key (financial_transaction_fk) references pspadm.psp_financial_transaction (financial_transaction_seq) ON DELETE NO ACTION ;
...
--alter table pspadm.psp_paycheck_usage_hist add constraint psp_paycheck_usage_hist_fk2 foreign key (company_fk,paycheck_usage_fk) references pspadm.psp_paycheck_usage (company_fk,paycheck_usage_seq) ON DELETE NO ACTION;
--alter table pspadm.psp_paycheck_usage_hist add constraint psp_paycheck_usage_hist_fk2 foreign key (paycheck_usage_fk) references pspadm.psp_paycheck_usage (paycheck_usage_seq) ON DELETE NO ACTION;
...
--------------------------------------------------------
--  ref constraints for table psp_qbdt_request_info
--------------------------------------------------------

--alter table pspadm.psp_qbdt_request_info add constraint psp_qbdt_request_info_fk1 foreign key (source_system_transmission_fk) references pspadm.psp_source_system_transmission (source_system_transmission_seq) ON DELETE NO ACTION ;
--------------------------------------------------------
...
--------------------------------------------------------
--  ref constraints for table psp_source_system_transmission
--------------------------------------------------------

--alter table pspadm.psp_source_system_transmission add constraint psp_source_system_transmis_fk1 foreign key (company_fk) references pspadm.psp_company (company_seq) ON DELETE NO ACTION;
--------------------------------------------------------
