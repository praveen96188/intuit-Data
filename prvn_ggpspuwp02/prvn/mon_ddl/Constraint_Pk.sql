...
ADD CONSTRAINT c_psp_event_type0 CHECK (event_type_cd IN ( 'InvalidVendorEmail', 'MonthlyFeeCreated', 'NOCWithOutChanges', 'OfferingUpdated', 'PSPToSMSMigration', 'PayrollAdminChanged', 'PaystubCreated', 'PositiveCobraReceived', 'PrimaryPrincipalDOBChanged', 'QuickBooksInfoChanged', 'RedebitDateUpdated', 'ReversalReturn', 'SendEmailFailed', 'TOKNotifiedOfCompanyFraud', 'TaxExemptStatusChanged', 'TrialAssetDetected', 'UsageBilling15DaysIntoSubscription', 'VendorBankAccountWalletSuccess', 'VmpSignUpEmployerEmail', 'ACHEnrollmentStatusChanged', 'AccountingFinancialLedgerAdjustmentCreated', 'BPIncreasePayrollLimit', 'ChangeRedebitToWireExpected', 'CloudResponse', 'CoaSalesTaxAccountChange', 'CompanyBankAccountVBDStatusChange', 'CompanyContactDeleted', 'CurrentPayrollPercentageIncrease', 'DDReject', 'DeletedPaycheckAlreadyOffloadedToTOK', 'EmployeeAdded', 'EmployeeDeleted', 'EmployeeUpdated', 'EnrollmentStatusChanged', 'EntitlementCodeChanged', 'InactivityBPPayrollAmountExceeded', 'InactivityDDPayrollAmountExceeded', 'IncorrectPIN', 'ManualDataSync', 'NonPrintChecks', 'PSPToAS400HoldRemoveSync', 'PayeePaidTooManyTimes', 'PayrollProcessedTooSoon', 'PayrollSubmittedWithPendingNOC', 'PayrollTaxPaymentVoided', 'PriceTypeChanged', 'PrimaryPrincipalSSNChanged', 'RequestProcessingFlagChanged', 'SalesTaxReturn', 'VoidedPaycheckAlreadyOffloadedToTOK', 'BackdatePriorToProcessingStart', 'BillPaymentRecalled', 'BillPaymentReceived', 'CBAVerifyReturn', 'CompanyContactEmailChanged', 'CompanyContactFaxChanged', 'CreditReduction', 'DDDebitReturn', 'DataRealmAttached', 'EINChanged', 'ERPayableRefundCreated', 'EmployeeSignedUp', 'EmployeesPaidToSameBankAccount', 'EntitlementCommunication', 'EntitlementUnitStatusChanged', 'HigherTokenSynced', 'ManualRedebitCreated', 'MultipleCompanyLawsCreated', 'NSF', 'RealmIdAdded', 'SMSToPSPSyncFailure', 'SUIEoqCreditCreated', 'SUIEoqDebitCreated', 'ServiceKeyUpdated', 'ServiceStatusChange', 'Strike', 'TransmissionError', 'AccountLocked', 'AddUserToRealmOnRealmChangeFailure', 'AssistedPayrollConfirmation', 'CompanyContactPhoneChanged', 'CompanyFundingModelChanged', 'CompanyIndustryTypeChanged', 'ConsentChange', 'EmployeeBankAccountChangedSpikeInPay', 'GrantAttached', 'InvalidEmployeeInformation', 'KeyPairGenerated', 'LegacySubscriptionMigration', 'ManualNoteEvent', 'NumberOfPayrollsPerDayExceeded', 'OfferClaimed', 'PINReset', 'PSPToSMSMigrationRevert', 'PaycheckRecalled', 'PaycheckRecalledAfterOffload', 'PayrollReceivedCloud', 'PayrollSubmissionIncludedAllNewEmployees', 'PreOffload401kValidationAlert', 'RiskProfileMigrated', 'TotalBillPaymentExceedsLimit', 'UsageBilling25DaysIntoSubscription', 'ZeroPayrollReceived', 'AIDUpdated', 'AddUserToRealmOnRealmChangeSuccess', 'BalanceFileReceived', 'BillingRealmCreated', 'CloneEmployeeWalletOnRealmChangeFailure', 'CompanyBankAccountChange', 'CompanyContactNameChanged', 'ERRefundReturn', 'Employee401kDataUploaded', 'EmployeeBankAccountChange', 'EmployeeInvited', 'EntitlementStateChanged', 'FeeCreated', 'FeeOffloaded', 'NOC', 'NewPSIDCreatedForExistingCustomer', 'PINUpdated', 'PayrollCancelled', 'PayrollRejected', 'SendEmailSkipped', 'StateIdModified', 'AS400Event', 'AddUserToRealmFailure', 'AuthenticationFailed', 'AutoEnabledVMP', 'BackdatedPayrollReceived', 'BankAccountVerified', 'CoaFeeAccountChange', 'CompanyBankAccountStatusChange', 'DGDeleteRequest', 'EmployeeBankAccountWalletFailure', 'EmployeeBankAccountWalletSuccess', 'EmployeePaidGreaterThanMax', 'EntitlementUnitAdded', 'FeeRebilled', 'FileIdChanged', 'InvalidPaycheckInformation', 'InvalidSourceSystemTransmissionInformation', 'ManualLedgerEntry', 'NonAchPaymentReceived', 'OFXServiceActivated', 'OfferRemoved', 'PINCreated', 'PSIDMismatch', 'PaymentMethodChanged', 'PayrollCancelPending', 'PayrollRecalled', 'PostOffload401kValidationAlert', 'PrefundingReceived', 'PrimaryPrincipalNameChanged', 'ReversalOK', 'RiskProfileUnMigrated', 'SMSRealmIdUpdated', 'SUICreditsApplied', 'SUIImmediateCreditCreated', 'SubscriptionEndDateChanged', 'VendorBankAccountWalletFailure', 'WelcomeEmail', 'ACHReturn', 'AddUserToRealmSuccess', 'AdditionalFilingAmount', 'AllowTransmissionsFlagChanged', 'AssistedEmployeeMigrationComplete', 'AssistedFailedEnrollment', 'BillPaymentOffloaded', 'BillingRealmAttached', 'CloneEmployeeWalletOnRealmChangeSuccess', 'CloneVendorWalletOnRealmChangeSuccess', 'CompanyContactAddressChanged', 'CompanyContactJobTitleChanged', 'CompanyContactRoleChanged', 'CompanyLawUpdated', 'CustomerSignedUp', 'DBANameChanged', 'DepositFrequencyChanged', 'ERPenaltiesAndInterestRefundDebitCreated', 'EmailAddressChanged', 'EmployeePaidEvenDollarAmount', 'EmployeePaidTooManyTimes', 'EmployeesPaidToSameBank', 'FeeRefunded', 'LegalAddressChanged', 'LegalNameChanged', 'LimitViolation', 'PSPToAS400HoldSync', 'PayeeAdded', 'PayeePaidGreaterThanMax', 'PayeeUpdated', 'PayrollReceived', 'PayrollSubmittedWithEmployeeWithPendingReturn', 'PayrollTaxPaymentReissued', 'ReversalRequested', 'SUIImmediateDebitCreated', 'SingleEmployeePercentageIncrease', 'SplitMMTReturn', 'TaxPaymentStatusChanged', 'ThresholdExceeded', 'TotalPayrollExceedsLimit', 'VmpSignUpEmployeeEmail', 'AssistedPayrollItemMigrationComplete', 'CompanyContactAdded', 'CompanyMatchesFraudulentCompany', 'ERPayableAppliedToBalanceDue', 'ERPenaltiesAndInterestRefundCreated', 'FeeReturn', 'LastChanceNotify', 'LiabilityAdjustmentCreated', 'PINUnlocked', 'PayeeBankAccountChange', 'PayrollReceivedPayCard', 'RealmIdUpdated', 'RedebitAmountUpdated', 'SMSToPSPSyncSuccess', 'SourceCompanyIdChanged', 'UpdateConsumerRealmId', 'WireExpected', 'ACHReturnStatusChanged', 'CloneVendorWalletOnRealmChangeFailure', 'ComplianceAddressChanged', 'DDIncreasePayrollLimit', 'DDMigration', 'DGAccessRequest', 'DuplicatePayrollItemReceived', 'ERLoanNOC', 'EmployeeBankAccountInTermedCompany', 'EmployeeInTermedCompany', 'EmployeePaidPercentageGreaterThanOthers', 'FirstPayrollReceived', 'FraudFlagRemovedEvent'));
