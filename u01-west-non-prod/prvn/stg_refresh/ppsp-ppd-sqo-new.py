...
def main():
    ...
    prod_cluster_identifier = 'ppsp-sys-mon'
    stage_cluster_identifier = 'ppsp-ppd-sqo'
    ...
    try:
        ...
        if rename_success and database_exists(db_host, db_user, intuadmin_password, new_db_name):
            execute_sql_file(db_host, new_db_name, db_user, intuadmin_password, sql_file)
            manage_pspadm_owner(db_host, new_db_name, db_user, intuadmin_password, pspadm_password)
        else:
