...
# Check the value of new_db_name and configure paths accordingly
    ...
    print(f"☑️☑️☑️STAGING DATABASE CONFIGURATION FOR: {new_db_name} ☑️☑️☑️")
    print(f"☑️☑️☑️OLD PASSWORDFILE PATH: {password_file_path}☑️☑️☑️")
    print(f"☑️☑️☑️NEW PASSWORDFILEPATH: {new_password_file_path}☑️☑️☑️")
    print(f"☑️☑️☑️APPUSERS PASSWORD FILE PATH: {appusers_file_path}☑️☑️☑️")
    print(f"☑️☑️☑️SQL SCRIPTS-1: {sql_file}☑️☑️☑️")
    print(f"☑️☑️☑️SQL SCRIPTS-2: {pitparmo_sql_file}☑️☑️☑️")
    print(f"☑️☑️☑️SQL Scripts-3: {pspadm_sql_file}☑️☑️☑️")
    print(f"☑️☑️☑️default DBname: {def_db_name}☑️☑️☑️")
    print(f"☑️☑️☑️masteruser: {master_user}☑️☑️☑️")
    print(f"☑️☑️☑️schemaowner: {schema_owner}☑️☑️☑️")
