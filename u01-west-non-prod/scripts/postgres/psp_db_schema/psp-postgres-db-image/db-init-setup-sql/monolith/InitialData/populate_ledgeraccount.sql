DROP TABLE IF EXISTS TEMP_PSP_LEDGER_ACCOUNT CASCADE
...
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_PSP_LEDGER_ACCOUNT (LIKE PSP_LEDGER_ACCOUNT INCLUDING ALL)
...
SET ( NAME, DESCRIPTION, VERSION, BALANCE_CALCULATION_RULE, LEDGER_ACCOUNT_TYPE, REPORTING_FREQUENCY, ACCOUNT_ABBREVIATION, REQUIRES_QUARTER_LAW) =
