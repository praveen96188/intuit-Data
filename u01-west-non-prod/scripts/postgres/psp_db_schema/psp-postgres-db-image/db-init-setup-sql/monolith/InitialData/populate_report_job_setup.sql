DROP TABLE IF EXISTS TEMP_PSP_REPORT_JOB_SETUP CASCADE;

--------------------------------------------------------
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_PSP_REPORT_JOB_SETUP (LIKE PSP_REPORT_JOB_SETUP INCLUDING ALL) ;
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Bank_Report','0 1 10,15,17 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Michael_Magness@intuit.com,EMSPAYROLLFRAUD@INTUIT.COM,SBGOPSIDCDBA@intuit.com,mayank_choubey@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
VALUES ('Nachafile_Report', '0 0 9 1 1/1 ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'pspprodstats@intuit.com,mayank_choubey@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, 'nachafile_rpt.sql', '/PSP/MONITOR', '{"0":{"columnName": "FileType","dbColumnName": "null","encrypted": "false"},
...
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  VALUES ('100k_Query', '0 6 22 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'michaelle_mcmullin@intuit.com,linda_holler@intuit.com,Elaine_perry@intuit.com,mayank_choubey@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, '100K_query.sql', '/PSP/MONITOR', '{"0":{"columnName": "SOURCE_COMPANY_ID","dbColumnName": "null","encrypted": "false"},
...
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES ('Financial_Transaction', '0 30 6 ? * MON,TUE,WED,THU,FRI,SAT *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'sbdriskmanagement@intuit.com,pspprodstats@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, 'ft1.sql', '/PSP/MONITOR', '{"0":{"columnName": "PSID","dbColumnName": "null","encrypted": "false"},
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP
   (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID,  REPORT_MAILING_LIST,
    QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values
   ('Missed_Payments_High_Priority', '0 10 9 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'psp_tax_payment_notify_prod@intuit.com,pspprodstats@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP
   (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID,  REPORT_MAILING_LIST,
    QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values
   ('Missed_payments_not_immediate', '0 10 9 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'psp_tax_payment_notify_prod@intuit.com,pspprodstats@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES ('Tax_Payments_Forecast', '0 5 6 ? * MON-FRI *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'psp_tax_payment_notify_prod@intuit.com,mayank_choubey@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, 'tax_payments_forecast.sql', '/PSP/MONITOR', '{"0":{"columnName": "Init Date","dbColumnName": "null","encrypted": "false"},
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID,  REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Eu_Err_Aging_Info', '0 10 6 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'SBCGPayrollCRT@intuit.com, Adam_Barnes@intuit.com,Melissa_Niswonger@Intuit.com, Alfred_Bouton@Intuit.com,Iris_Cubero@intuit.com,Dawn_Pfiel@intuit.com,Patrick_Riley@intuit.com,Simon_Santiago@intuit.com,Stephen_Weinzetl@Intuit.com,winnie_wong@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES ('Company_Agency_Info', '0 17 5 ? * MON-FRI *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'TaxDeposits@intuit.com,mayank_choubey@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, 'agencyinfo_15719.sql', '/PSP/MONITOR', ' {"0":{"columnName": "FED_TAX_ID","dbColumnName": "PSP/Company_FedTaxId_AES256SIV","encrypted": "true"},
  "1":{"columnName": "PSID","dbColumnName": "null","encrypted": "false"},
  "2":{"columnName": "LEGAL_NAME","dbColumnName": "null","encrypted": "false"},
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP
   (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID,  REPORT_MAILING_LIST,
    QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values
   ('Company_Agency_Info_SUI', '0 20 5 ? * MON-FRI *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'TaxDeposits@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 'agencyinfo_2_15719.sql', 1, '/PSP/MONITOR', '{"0":{"columnName": "FED_TAX_ID","dbColumnName": "PSP/Company_FedTaxId_AES256SIV","encrypted": "true"},
  "1":{"columnName": "PSID","dbColumnName": "null","encrypted": "false"},
  "2":{"columnName": "LEGAL_NAME","dbColumnName": "null","encrypted": "false"},
  "3":{"columnName": "ADDRESS_LINE_1","dbColumnName": "null","encrypted": "false"},
  "4":{"columnName": "ADDRESS_LINE_2","dbColumnName": "null","encrypted": "false"},
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP
   (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID,  REPORT_MAILING_LIST,
    QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values
   ('Company_Agency_Info_SUI_Debit', '0 10 5 ? * MON-FRI *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'TaxDeposits@intuit.com, Ronnie_Jacobson@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 'agencyinfo_3_15719.sql', 1, '/PSP/MONITOR', '{"0":{"columnName": "FED_TAX_ID","dbColumnName": "PSP/Company_FedTaxId_AES256SIV","encrypted": "true"},
  "1":{"columnName": "PSID","dbColumnName": "null","encrypted": "false"},
  "2":{"columnName": "LEGAL_NAME","dbColumnName": "null","encrypted": "false"},
  "3":{"columnName": "ADDRESS_LINE_1","dbColumnName": "null","encrypted": "false"},
  "4":{"columnName": "ADDRESS_LINE_2","dbColumnName": "null","encrypted": "false"},
...
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES ('Duplicate_Adjustments', '0 0 7 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Linda_Holler@intuit.com,taxdeposits@intuit.com,mayank_choubey@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, 'jira_24717.sql', '/PSP/MONITOR', '{"0":{"columnName": "PSID","dbColumnName": "null","encrypted": "false"},
 "1":{"columnName": "EIN","dbColumnName": "PSP/Company_FedTaxId_AES256SIV","encrypted": "true"},
 "2":{"columnName": "LEGAL_NAME","dbColumnName": "null","encrypted": "false"},
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values ('Complia_Adjustments', '0 30 6,8,10,12,14,16,18 * * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'TeamMoore@Intuit.com, Wendy_Moore@Intuit.com, Krista_Richmond@Intuit.com, Trina_Cotta@Intuit.com, Evan_Ramirez@Intuit.com,Anita_StAndry@Intuit.com, Wendy_Moore@Intuit.com, Krista_Richmond@Intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES ('Assisted_On_Hold_Info', '0 45 9 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'dify_cancellations@intuit.com, Alanna_Ainsworth@intuit.com, Wesley_Jorgensen@Intuit.com, SBG-EMSAssistedHoldDistributionList@intuit.com, Julie_Merica@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, 'jira_27019.sql', '/PSP/MONITOR', '{"0":{"columnName": "LEGAL_NAME","dbColumnName": "null","encrypted": "false"},
 "1":{"columnName": "EIN ","dbColumnName": "PSP/Company_FedTaxId_AES256SIV","encrypted": "true"},
...
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES ('Financial_Ledger', '0 30 20 ? * SAT *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Kavita_Rivers@intuit.com, Iris_Matthews@intuit.com, EMSAccounting@intuit.com,mayank_choubey@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, 'finledger.sql', '/PSP/MONITOR', '{"0":{"columnName": "PSID","dbColumnName": "null","encrypted": "false"},
 "1":{"columnName": "LEGAL_NAME","dbColumnName": "null","encrypted": "false"},
 "2":{"columnName": "VARIANCE","dbColumnName": "null","encrypted": "false"}}')
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES ('ms_m89_payment_info', '0 10 0 15,16,17,18,19,20 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'taxdeposits@intuit.com,mayank_choubey@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END), 1, 'jira_psp-5003.sql', '/PSP/MONITOR', '{"0":{"columnName": "fed_tax_id","dbColumnName": "PSP/FSET_FLDtl_EIN_AES256SIV","encrypted": "true"},
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID,  REPORT_MAILING_LIST,
  QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values ('Late_Payment_Stats', '0 12 5 1 1/1 ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Linda_Holler@Intuit.com, Payrollservicesmaintenance@Intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Late_Payment_Details', '0 12 5 1 1/1 ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Linda_Holler@Intuit.com, Payrollservicesmaintenance@Intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('EIN_DEACTIVATION_LIST', '0 15 1 7-13,21-28 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Manjunatha_Ramakrishnappa@intuit.com, Raveena_Mahajan@intuit.com, Malthi_SS@intuit.com, Vanaja_Nataraj@intuit.com, Srinivas_Vinti@intuit.com, Praveenkumar_Hoolimath@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
   'jira_47671.sql', 1, '/PSP/MONITOR', '{"0":{"columnName": "EIN_TO_DEACTIVATE","dbColumnName": "PSP/EntUnit_FedTaxId_AES256SIV","encrypted": "true"}}')
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Assisted_Usage_Billing', '0 30 7 ? * SUN *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Alanna_Ainsworth@intuit.com, Wesley_Jorgensen@Intuit.com, SBG-EMSAssistedHoldDistributionList@intuit.com, Julie_Merica@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Back_Dated_Paychecks', '0 20 7 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'linda_holler@intuit.com, PQAReport@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('ASSISTED_NEW_CUSTOMER_LIST', '0 30 18 15 3,6,9,12 ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Kimberly_Han@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Foreign_Routing_Number', '0 5 17 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Iolanta_Green@intuit.com,Manjunatha_Ramakrishnappa@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Manual_DataSync_Rep', '0 5 5 2 1/1 ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Theresa_Arnold@intuit.com, Dawn_Pfiel@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('Psp_Cancelled_Assisted_Info', '0 30 15 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'DIFY_Cancellations@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('ASSISTED_QB_DISCO_CUSTOMER_LIST', '0 20 5 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Alex_Sutich@intuit.com, Joyce_Lee2@intuit.com, David_Jost@intuit.com, Jennifer_Stansbury@intuit.com, Julie_Merica@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Back_Dated_voids', '0 5 6 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Linda_Holler@intuit.com,Haique_Aguilar@Intuit.com,Payrollservicesmaintenance@Intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Assisted_Agency_Info_Rpt_SUI', '0 14 7 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'TaxDeposits@Intuit.com,Tax_ServiceSetup@intuit.com, Payrollservicesmaintenance@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Assisted_Agency_Info_Rpt_SIT', '0 14 7 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'TaxDeposits@Intuit.com,Tax_ServiceSetup@intuit.com, Payrollservicesmaintenance@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('PSP_COMPANY','0 15 0 * * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'EMSIDC_OpsTeam@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('PSP_contact','0 15 0 * * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'EMSIDC_OpsTeam@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('PSP_STATEID','0 15 0 * * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'EMSIDC_OpsTeam@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('Bad_EE_Accounts','0 0 17 1/1 * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Michael_Magness@intuit.com, EMSPayrollFraud@intuit.com, SBGOPSIDCDBA@intuit.com, Mayank_Choubey@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('Bad_Funding_Account','0 0 17 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Michael_Magness@intuit.com, EMSPayrollFraud@intuit.com, SBGOPSIDCDBA@intuit.com, Mayank_Choubey@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('bank_report_withvac','0 06 10,15,17 * * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Michael_Magness@intuit.com,EMSPAYROLLFRAUD@INTUIT.COM,Iolanta_Green@intuit.com,Swarnashis_Sarkar@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  VALUES ('Assisted_Activation_Report', '0 0 6 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Tax_ServiceSetup@Intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Assisted_Payroll_Discount_Rpt', '0 0 11 2 2,5,8,11 ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Alex_Sinai@intuit.com, Josh_Baker@intuit.com, Sumit_Poddar@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
 ...
 INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('Assisted_Payroll_Refund_Rpt', '0 10 11 2 2,5,8,11 ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Alex_Sinai@intuit.com, Josh_Baker@intuit.com, Sumit_Poddar@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP (REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
 Values ('ASSISTED_DISCO_CUSTOMER_LIST_NEW', '0 30 5 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Alex_Sutich@intuit.com, Joyce_Lee2@intuit.com, Jennifer_Stansbury@intuit.com, dify_cancellations@intuit.com, nathan_stieg@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
 ...
 INSERT INTO TEMP_PSP_REPORT_JOB_SETUP ( REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  VALUES ('New_Signups_Report', '0 0 6 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'IntuitPayrollAccountReview@intuit.com, Kavita_Rivers@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
Values
('EU_activ_err_count_exceed_limit','0 1 7 * * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'RNPSPALERTPROD@intuit.com,melissa_niswonger@intuit.com,Theresa_Arnold@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
'jira_25922.sql', 1, '/PSP/MONITOR', '{"0":{"columnName": "count","dbColumnName": "null","encrypted": "false"}}')
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('mmt_rec_count_exceed','0 30 10 * * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Tricia_Parks@intuit.com,Rob_Histing@Intuit.com,Iolanta_Green@intuit.com,Linda_Holler@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
'jira_7907.sql', 0, '/PSP/MONITOR',
'{"0":{"columnName": "count","dbColumnName": "null","encrypted": "false"}}')
;
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('dd_limit_inf_jirapsp_6681','0 5 0 * * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'IntuitPayrollAccountReview@intuit.com,Kavita_Rivers@intuit.com,SBDRiskManagement@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('Direct_Deposit_Paycheck_Data','0 5 5 4 * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Kristin_Stroupe@Intuit.com,Iolanta_Green@intuit.com,Tricia_Parks@intuit.com,Shivananda_Devannavar@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('Cancelled_By_MissedPayrollsBatchJob','0 7 5 * * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'SBDRiskManagement@intuit.com,iris_matthews@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('mmt_info_per_payment_template','0 10 6 ? * 2-6 *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'TaxDeposits@Intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('VMP_Counts_Jira_20870','0 0 2 * * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'THR-TAVMPResults@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('Manual_Ledger_Entry_Report','0 22 4 1 * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'SBCPayrollCRT@intuit.com,Linda_Holler@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('psp_6672_4_query','0 30 5 1 * ? *',  1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'aditya_bhardwaj@intuit.com,linda_holler@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('PSP_Entitlement_AppUser','0 15 0 * * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'EMSIDC_OpsTeam@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('PSP_Entitlement_DBUser','0 15 0 * * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'EMSIDC_OpsTeam@intuit.com,SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
(REPORT_NAME, REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST,
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
  Values
  ('PSP_SOX_AppUser','0 0 8 ? * SUN *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Tech-t4i_IT_RISK_Compliance@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP
 ...
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES
('Assisted_Agency_aid_rpt_SUI', 1, -1, '0 14 7 1/1 * ? *', (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Tax_ServiceSetup@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
INSERT INTO TEMP_PSP_REPORT_JOB_SETUP
 ...
 QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
VALUES
('Assisted_Agency_aid_rpt_SIT', 1, -1, '0 14 7 1/1 * ? *', (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'Tax_ServiceSetup@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
QUERY_FILENAME, IS_AUTOMATICALLY_SCHEDULED, REPORT_NAMESPACE, ENCRYPTED_FIELDS)
Values
('Assisted_Agency_Info_Rpt_Others', '0 14 7 1/1 * ? *', 1, -1, (CASE WHEN FN_GET_ENV() = 'PROD' THEN 'TaxDeposits@Intuit.com,Tax_ServiceSetup@intuit.com, Payrollservicesmaintenance@intuit.com, SBGPayrollPSPDevteam@intuit.com' ELSE 'SBGPayrollPSPScrumTeam@intuit.com' END),
...
SET (REPORT_SCHEDULE, VERSION, REALM_ID, REPORT_MAILING_LIST, IS_AUTOMATICALLY_SCHEDULED, QUERY_FILENAME, REPORT_NAMESPACE, ENCRYPTED_FIELDS) =
(SELECT
