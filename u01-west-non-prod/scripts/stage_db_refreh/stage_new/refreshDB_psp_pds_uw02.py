...
def main():
    ...
    stage_cluster_identifier = 'ppsp-sys-mon'
    ...
    appusers_file_path = '/u01/scripts/stage_db_refreh/stage_new/appusers_password.txt'
    pitparmo_sql_file = '/u01/scripts/stage_db_refreh/stage_new/pitparmo_postgres.sql'
    vacuum_script_path = '/u01/prvn/stg_refresh/vacuum/vacuum/vacuum_ppsp-pds-db-new.sh'
    analyze_script_path = '/u01/prvn/stg_refresh//vacuum/analyze/ppsp-ppd-new.sh'
    pspadm_sql_file = '/u01/scripts/stage_db_refreh/stage_new/pspadmowner_pitparmo.sql'
    db_name = 'ppdspg02'
