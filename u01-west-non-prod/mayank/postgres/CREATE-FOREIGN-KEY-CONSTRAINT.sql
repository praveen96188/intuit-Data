...
ALTER TABLE pspadm.psp_company_law
ADD CONSTRAINT psp_company_law_fk3 FOREIGN KEY (qbdt_payroll_item_info_fk, realm_id) 
REFERENCES pspadm.psp_qbdt_payroll_item_info (qbdt_payroll_item_info_seq, realm_id)
ON DELETE NO ACTION;
...
ALTER TABLE pspadm.psp_company_payroll_item
ADD CONSTRAINT psp_company_payroll_item_fk3 FOREIGN KEY (qbdt_payroll_item_info_fk, realm_id) 
REFERENCES pspadm.psp_qbdt_payroll_item_info (qbdt_payroll_item_info_seq, realm_id)
ON DELETE NO ACTION;
...
ALTER TABLE pspadm.psp_compensation
ADD CONSTRAINT psp_compensation_fk3 FOREIGN KEY (qbdt_payline_info_fk, realm_id) 
REFERENCES pspadm.psp_qbdt_payline_info (qbdt_payline_info_seq, realm_id)
ON DELETE NO ACTION;
...
ALTER TABLE pspadm.psp_deduction
ADD CONSTRAINT psp_deduction_fk3 FOREIGN KEY (qbdt_payline_info_fk, realm_id) 
REFERENCES pspadm.psp_qbdt_payline_info (qbdt_payline_info_seq, realm_id)
ON DELETE NO ACTION;
...
ADD CONSTRAINT psp_employee_to_process_to_fk1 FOREIGN KEY (employee_fk, realm_id) 
REFERENCES pspadm.psp_employee (employee_seq, realm_id)
ON DELETE NO ACTION;
...
ADD CONSTRAINT psp_employer_contribution_fk1 FOREIGN KEY (qbdt_payline_info_fk, realm_id) 
REFERENCES pspadm.psp_qbdt_payline_info (qbdt_payline_info_seq, realm_id)
ON DELETE NO ACTION;
...
ALTER TABLE pspadm.psp_financial_transaction
ADD CONSTRAINT psp_financial_transaction_fk15 FOREIGN KEY (bill_payment_split_fk, realm_id) 
...
ADD CONSTRAINT psp_fin_txn_hold_fk_hold FOREIGN KEY (on_hold_reason_fk, realm_id) 
REFERENCES pspadm.psp_on_hold_reason (on_hold_reason_seq, realm_id)
ON DELETE NO ACTION;
