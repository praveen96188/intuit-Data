...
create user pspapp with password 'IgRgK7d#PrG';
...
grant  pg_read_all_data to pspadm_readwrite_role;
grant  pg_read_all_settings to pspadm_readwrite_role;
grant  pg_read_all_stats to pspadm_readwrite_role;
grant  pg_stat_scan_tables to pspadm_readwrite_role;

grant  pg_read_all_data to pspadm_readonly_role;
grant  pg_read_all_settings to pspadm_readonly_role;
grant  pg_read_all_stats to pspadm_readonly_role;
grant  pg_stat_scan_tables to pspadm_readonly_role;
...
grant select on dual to  pspadm_readonly_role;



\c ppdspg02 pspadm_owner
