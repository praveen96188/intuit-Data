...
split partition SRCSYSTRNS_9999 at (to_date('02/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M012024 ,
 partition SRCSYSTRNS_9999 
 )
UPDATE INDEXES;

alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('03/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M022024  tablespace PSP_LOB01,
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('04/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M032024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('05/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M042024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('06/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M052024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('07/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M062024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('08/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M072024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('09/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M082024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('10/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M092024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('11/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M102024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('12/01/2024', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M112024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
alter table ibobadm.PSP_SOURCE_SYSTEM_TRANSMISSION
split partition SRCSYSTRNS_9999 at (to_date('01/01/2025', 'MM/DD/YYYY'))
into
(partition SRCSYSTRNS_M122024  tablespace PSP_LOB01,
 partition SRCSYSTRNS_9999  tablespace PSP_LOB01
LOB (REQUEST_DOCUMENT, RESPONSE_DOCUMENT) STORE AS (TABLESPACE PSP_LOB01)
 )
UPDATE INDEXES;
...
select segment_name, segment_type, partition_name, tablespace_name from dba_segments where owner = 'IBOBADM' and segment_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION' and partition_name like 'SRCSYSTRNS_M%2024%' order by partition_name;
...
select table_name, partition_name, high_value, tablespace_name from dba_tab_partitions where table_owner = 'IBOBADM' and table_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION' and partition_name like 'SRCSYSTRNS_M%2024%' order by partition_position;
select table_name, subpartition_name, high_value, tablespace_name from dba_tab_subpartitions where table_owner = 'IBOBADM' and table_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION' and partition_name like 'SRCSYSTRNS_M%2024%' order by partition_name, subpartition_position;
select index_name, partition_name, high_value, tablespace_name, status from dba_ind_partitions where index_owner = 'IBOBADM' and index_name in (select index_name from dba_indexes where owner = 'IBOBADM' and table_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION') and partition_name like 'SRCSYSTRNS_M%2024%' order by partition_position;
select index_name, subpartition_name, high_value, tablespace_name, status from dba_ind_subpartitions where index_owner = 'IBOBADM' and index_name in (select index_name from dba_indexes where owner = 'IBOBADM' and table_name = 'PSP_SOURCE_SYSTEM_TRANSMISSION') and partition_name like 'SRCSYSTRNS_M%2024%' order by partition_name, subpartition_position;
