DECLARE
    ...
    START_DATE         DATE := TO_DATE('2010-12-21', 'yyyy-mm-dd');
            ...
            WHILE (BATCH_COUNT > 0 AND PROCESSED_RECORDS < MAX_RECORDS)
                ...
                LOOP
                    BEGIN
                        ...
                        MERGE INTO PSPADM.PSP_EMPLOYER_CONTRIBUTION c
                        using (SELECT ci.EMPLOYER_CONTRIBUTION_SEQ, pi.COMPANY_FK
                               FROM PSPADM.PSP_EMPLOYER_CONTRIBUTION ci,
                        ...
                        on (c.EMPLOYER_CONTRIBUTION_SEQ = p.EMPLOYER_CONTRIBUTION_SEQ)
                        when matched then
