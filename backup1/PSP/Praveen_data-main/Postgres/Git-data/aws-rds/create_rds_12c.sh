...
if [ $# -eq 5 ]; then
  ...
  echo "Usage: ./create_rds.sh <AppEnv> <DBType> <DBName> <Region> <VPC>"
...
echo "  { \"ParameterKey\": \"EngineVersion\", \"ParameterValue\": \"12.1.0.2.v19\" }," >> cf_rds_parameter_${app_env}_${db_type}-${db_name}-${vpc}.json
