...
sed -i "s|<datacomp_html_file value=\"\"/>|<datacomp_html_file value=\"/u01/ogg/scripts/dbsolo5/results/results_QRI_AUD-MON_${START_DATE}-${END_DATE}.html\"/>|" QRI_comparision.xml
sed -i "s|<datacomp_sync_filename value=\"\"/>|<datacomp_sync_filename value=\"/u01/ogg/scripts/dbsolo5/results/results_QRI_AUD-MON_${START_DATE}-${END_DATE}.sql\"/>|" QRI_comparision.xml
