...
CREATE TABLE pspadm.psp_entity_update_m122024
        ...
        FOR VALUES FROM ('2024-12-01 00:00:00') TO ('2025-12-01 00:00:00');
...
CREATE TABLE pspadm.psp_entity_update_m122025
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2025-12-01 00:00:00') TO ('2026-12-01 00:00:00');
...
CREATE TABLE pspadm.psp_entity_update_m122026
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2026-12-01 00:00:00') TO ('2027-12-01 00:00:00');
