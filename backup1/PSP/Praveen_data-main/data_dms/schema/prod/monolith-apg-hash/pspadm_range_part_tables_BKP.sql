...
CREATE TABLE pspadm.psp_entitlement_message_2024
        PARTITION OF pspadm.psp_entitlement_message
        FOR VALUES FROM ('2024-01-01 00:00:00') TO (MAXVALUE);
...
CREATE TABLE pspadm.psp_entity_update_m122023
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2023-12-01 00:00:00') TO (MAXVALUE);

CREATE TABLE pspadm.psp_entity_update_m112023
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2023-11-01 00:00:00') TO ('2023-12-01 00:00:00');

CREATE TABLE pspadm.psp_entity_update_m102023
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2023-10-01 00:00:00') TO ('2023-11-01 00:00:00');

CREATE TABLE pspadm.psp_entity_update_m092023
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2023-09-01 00:00:00') TO ('2023-10-01 00:00:00');

CREATE TABLE pspadm.psp_entity_update_m082023
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2023-08-01 00:00:00') TO ('2023-09-01 00:00:00');

CREATE TABLE pspadm.psp_entity_update_m072023
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2023-07-01 00:00:00') TO ('2023-08-01 00:00:00');

CREATE TABLE pspadm.psp_entity_update_m062023
        PARTITION OF pspadm.psp_entity_update
        FOR VALUES FROM ('2023-06-01 00:00:00') TO ('2023-07-01 00:00:00');

CREATE TABLE pspadm.psp_entity_update_m052023
        PARTITION OF pspadm.psp_entity_update
...
ALTER TABLE pspadm.psp_entity_update_m052023 ADD CONSTRAINT psp_entity_update_m052023_pk PRIMARY KEY (entity_update_seq, realm_id);
ALTER TABLE pspadm.psp_entity_update_m062023 ADD CONSTRAINT psp_entity_update_m062023_pk PRIMARY KEY (entity_update_seq, realm_id);
ALTER TABLE pspadm.psp_entity_update_m072023 ADD CONSTRAINT psp_entity_update_m072023_pk PRIMARY KEY (entity_update_seq, realm_id);
ALTER TABLE pspadm.psp_entity_update_m082023 ADD CONSTRAINT psp_entity_update_m082023_pk PRIMARY KEY (entity_update_seq, realm_id);
ALTER TABLE pspadm.psp_entity_update_m092023 ADD CONSTRAINT psp_entity_update_m092023_pk PRIMARY KEY (entity_update_seq, realm_id);
ALTER TABLE pspadm.psp_entity_update_m102023 ADD CONSTRAINT psp_entity_update_m102023_pk PRIMARY KEY (entity_update_seq, realm_id);
ALTER TABLE pspadm.psp_entity_update_m112023 ADD CONSTRAINT psp_entity_update_m112023_pk PRIMARY KEY (entity_update_seq, realm_id);
ALTER TABLE pspadm.psp_entity_update_m122023 ADD CONSTRAINT psp_entity_update_m122023_pk PRIMARY KEY (entity_update_seq, realm_id);
