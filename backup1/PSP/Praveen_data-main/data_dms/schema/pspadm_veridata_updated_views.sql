...
CREATE OR REPLACE VIEW pspadm.psp_pstub_employee_info_veridata_view as  
...
CREATE OR REPLACE VIEW pspadm.psp_compensation_veridata_view as  
...
CREATE OR REPLACE VIEW pspadm.psp_ledger_balance_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_money_movement_transaction_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_company_event_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_company_event_detail_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_company_event_email_param_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_financial_transaction_veridata_view as
...
CREATE OR REPLACE VIEW pspadm.psp_paycheck_split_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_qbdt_payline_info_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_financial_trans_state_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_pstub_pay_item_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_tax_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_paycheck_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_qbdt_paycheck_info_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_entry_detail_record_veridata_view as 
...
select * from pspadm.psp_entry_detail_record_p12 union all
select * from pspadm.psp_entry_detail_record_p9  ;

CREATE OR REPLACE VIEW pspadm.psp_property_audit_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_disburse_advice_tax_liab_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_qbdt_transaction_info_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_paystub_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_deduction_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_pstub_paid_timeoff_item_veridata_view as 
...
CREATE OR REPLACE VIEW pspadm.psp_paycheck_usage_veridata_view as
...
select * from pspadm.psp_paycheck_usage_2024 union all
select * from pspadm.psp_paycheck_usage_2025 union all
select * from pspadm.psp_paycheck_usage_2026;


CREATE OR REPLACE VIEW pspadm.psp_entity_update_veridata_view as
...
select * from pspadm.psp_entity_update_m122023 union all
select * from pspadm.psp_entity_update_m012024 union all
select * from pspadm.psp_entity_update_m022024 union all
select * from pspadm.psp_entity_update_m032024 union all
select * from pspadm.psp_entity_update_m042024 union all
select * from pspadm.psp_entity_update_m052024 union all
select * from pspadm.psp_entity_update_m062024 union all
select * from pspadm.psp_entity_update_m072024 union all
select * from pspadm.psp_entity_update_m082024 union all
select * from pspadm.psp_entity_update_m092024 union all
select * from pspadm.psp_entity_update_m102024 union all
select * from pspadm.psp_entity_update_m112024 union all
select * from pspadm.psp_entity_update_m122024 union all
select * from pspadm.psp_entity_update_m012025 union all
select * from pspadm.psp_entity_update_m022025 union all
select * from pspadm.psp_entity_update_m032025 union all
select * from pspadm.psp_entity_update_m042025 union all
select * from pspadm.psp_entity_update_m052025 union all
select * from pspadm.psp_entity_update_m062025 union all
select * from pspadm.psp_entity_update_m072025 union all
select * from pspadm.psp_entity_update_m082025 union all
select * from pspadm.psp_entity_update_m092025 union all
select * from pspadm.psp_entity_update_m102025 union all
select * from pspadm.psp_entity_update_m112025 union all
select * from pspadm.psp_entity_update_m122025 union all
select * from pspadm.psp_entity_update_m012026 union all
select * from pspadm.psp_entity_update_m022026 union all
select * from pspadm.psp_entity_update_m032026 union all
select * from pspadm.psp_entity_update_m042026 union all
select * from pspadm.psp_entity_update_m052026 union all
select * from pspadm.psp_entity_update_m062026 union all
select * from pspadm.psp_entity_update_m072026 union all
select * from pspadm.psp_entity_update_m082026 union all
select * from pspadm.psp_entity_update_m092026 union all
select * from pspadm.psp_entity_update_m102026 union all
select * from pspadm.psp_entity_update_m112026 union all
select * from pspadm.psp_entity_update_m122026 ;
...
CREATE OR REPLACE VIEW pspadm.psp_entitlement_message_veridata_view as
...
select * from pspadm.psp_entitlement_message_2024 union all
select * from pspadm.psp_entitlement_message_2025 union all
select * from pspadm.psp_entitlement_message_2026;
