...
def main(prod_cluster_identifier, stage_cluster_identifier, db_name, new_db_name):
    ...
    password_file_path = '/u01/scripts/staging_refresh/archival_Refresh/.op'
    new_password_file_path = '/u01/scripts/staging_refresh/archival_Refresh/.np'
    appusers_file_path = '/u01/scripts/staging_refresh/archival_Refresh/.ap'
    sql_file = '/u01/scripts/staging_refresh/archival_Refresh/postgres_postgres.sql'
    pitparmo_sql_file = '/u01/scripts/staging_refresh/archival_Refresh/psparcdb_postgres.sql'
##   vacuum_script_path = '/u01/scripts/staging_refresh/archival_Refresh/vacuum/vacuum_pitparmo-new.sh'
##   analyze_script_path = '/u01/scripts/staging_refresh/archival_Refresh/vacuum/analyze/ppsp-ppd-new.sh'
    pspadm_sql_file = '/u01/scripts/staging_refresh/archival_Refresh/psparcowner_psparcdb.sql'
