...
def main():
    ...
    prod_cluster_identifier = 'ppsp-pds-uw02'
    stage_cluster_identifier = 'ppsp-ppd-arc'
    password_file_path = '/u01/scripts/staging_refresh_script/db_password.txt'
    new_password_file_path = '/u01/scripts/staging_refresh_script/intuadmin_new_password.txt'
    sql_file = '/u01/scripts/staging_refresh_script/postgres_postgres.sql'
    appusers_file_path = '/u01/scripts/staging_refresh_script/appusers_password.txt'
    pitparmo_sql_file = '/u01/scripts/staging_refresh_script/pitparmo_postgres.sql'
    vacuum_script_path = '/u01/scripts/staging_refresh_script/vacuum/vacuum_pitparmo.sh'
    analyze_script_path = '/u01/prvn/stg_refresh//vacuum/analyze/ppsp-ppd-new.sh'
    pspadm_sql_file = '/u01/scripts/staging_refresh_script/pspadmowner_pitparmo.sql'
    db_name = 'ppdspg02'
    new_db_name = 'pitparmo'
