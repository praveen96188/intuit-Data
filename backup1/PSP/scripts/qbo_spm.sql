CREATE TABLE "SBG_VDBA"."SPM_SQL_ID_STATS" 
   (	"CLUSTER_ID" VARCHAR2(10 BYTE), 
	...
	"CREATE_DATE" DATE, 
	"RUN_ID" NUMBER, 
	"SQL_ID_HANDLE" VARCHAR2(512 BYTE)
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;

  CREATE INDEX "SBG_VDBA"."SPM_SQL_ID_STATS_SQL_ID_RUN_ID" ON "SBG_VDBA"."SPM_SQL_ID_STATS" ("SQL_ID", "RUN_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
CREATE TABLE "SBG_VDBA"."SPM_QBO_CLUSTERS" 
   (	"CLUSTER_ID" VARCHAR2(10 BYTE), 
	"CLUSTER_SID_QCY" VARCHAR2(10 BYTE), 
	"CLUSTER_SID_LAS" VARCHAR2(10 BYTE), 
	"CLUSTER_TYPE" VARCHAR2(10 BYTE), 
	"CLUSTER_SID_UW2" VARCHAR2(10 BYTE), 
	"CLUSTER_IP_QCY" VARCHAR2(30 BYTE), 
	"CLUSTER_IP_LAS" VARCHAR2(30 BYTE)
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
create or replace PACKAGE          QBO_SPM
AUTHID CURRENT_USER
IS
