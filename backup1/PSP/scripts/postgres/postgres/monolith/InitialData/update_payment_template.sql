...
UPDATE PSP_PAYMENT_TEMPLATE
SET TXP_RECORD_CLASS='com.intuit.sbd.payroll.psp.agency.ach.txp.Txp_'|| coalesce(substr(PAYMENT_TEMPLATE_CD, 1, 2),'')||'_WH' ,
...
;
UPDATE PSP_PAYMENT_TEMPLATE
SET TXP_RECORD_CLASS='com.intuit.sbd.payroll.psp.agency.ach.txp.Txp_'|| coalesce(substr(PAYMENT_TEMPLATE_CD, 1, 2),'')||'_UI',
    CATEGORY = 'SUI'
WHERE PAYMENT_TEMPLATE_CD in
('AL-CR4UI-PAYMENT',
 'AZ-UC018-PAYMENT',
