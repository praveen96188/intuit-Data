DROP TABLE IF EXISTS TEMP_EVENT_TYPE CASCADE;

DROP TABLE IF EXISTS TEMP_EVENT_DETAIL_TYPE CASCADE;

DROP TABLE IF EXISTS TEMP_EVTDTLTP_EVTTP_ASSOC CASCADE;

DROP TABLE IF EXISTS TEMP_EVTTP_SRCSYS_ASSOC CASCADE;

--------------------------------------------------------
-- Create temp table                                  --
--------------------------------------------------------

CREATE TABLE TEMP_EVENT_TYPE (LIKE PSP_EVENT_TYPE INCLUDING ALL) ;


CREATE TABLE TEMP_EVENT_DETAIL_TYPE (LIKE PSP_EVENT_DETAIL_TYPE INCLUDING ALL) ;

CREATE TABLE TEMP_EVTDTLTP_EVTTP_ASSOC
(
  EVENT_DETAIL_TYPE_FK  VARCHAR(255)      NOT NULL,
  EVENT_TYPE_FK         VARCHAR(255)      NOT NULL
);

CREATE TABLE TEMP_EVTTP_SRCSYS_ASSOC (LIKE PSP_EVTTP_SRCSYS_ASSOC INCLUDING ALL) ;
...
;
INSERT INTO TEMP_EVENT_TYPE ( EVENT_TYPE_CD, VERSION, NAME, DESCRIPTION, EVENT_GROUP_CD ) VALUES (
'SendEmailFailed', 0, NULL, 'Send Email Failed for {EmailTemplateType}, Email address:{RecipientEmailAddress}, Error code:{ErrorCode} Message:{ErrorMessage}', 'CompanyInfo')
;
INSERT INTO TEMP_EVENT_TYPE ( EVENT_TYPE_CD, VERSION, NAME, DESCRIPTION, EVENT_GROUP_CD ) VALUES (
'SendEmailSkipped', 0, NULL, 'Send Email skipped for {EmailTemplateType}, Email address:{RecipientEmailAddress}', 'CompanyInfo')
;
INSERT INTO TEMP_EVENT_TYPE ( EVENT_TYPE_CD, VERSION, NAME, DESCRIPTION, EVENT_GROUP_CD ) VALUES (
...
'ACHEventCd', 0, 'ACH Return CD', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ACHReturnReasonCode', 0, 'ACH Return Reason Code', NULL, 'com.intuit.sbd.payroll.psp.domain.ACHReturnReason')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'Amount', 0, 'Amount', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'AgencyId', 0, 'Agency Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'AS400EventToken', 0, 'AS400 event token [Historical]', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'AS400EventName', 0, 'AS400 event name [Historical]', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'AS400EventOFX', 0, 'AS400 event OFX [Historical]', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'BankAccountNumber', 0, 'Bank Account Number', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'BankAccountRoutingNumber', 0, 'Bank Account Routing Number', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'BillPaymentId', 0, 'Vendor Payment Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CancellationDateTime', 0, 'Cancellation Date Time', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CaseId', 0, 'Case Id for any update', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CoaNameChangeByAgent', 0, 'Chart Of Account Name Change By Agent', NULL, 'java.lang.Boolean')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CollectionStage', 0, 'Collection Stage', NULL, 'com.intuit.sbd.payroll.psp.domain.CollectionStageCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CompanyAgency', 0, 'Company Agency', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CompanyBankAccountId', 0, 'Company Bank Account Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CompanyEventId', 0, 'Company Event Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CompanyServiceId', 0, 'Company Service Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ContactId', 0, 'Contact Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'Details', 0, 'Details', 'Used to provide detailed information regarding the event in complete sentence form', 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EmployeeBankAccountId', 0, 'Employee BankAccount Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EmployeeId', 0, 'Employee Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EmployeeName', 0, 'Employee Name', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EmployeeInvalidReason', 0, 'Reason Employee was invalid', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EnrollmentType', 0, 'Enrollment Type', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ErrorCode', 0, 'Error Code', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ErrorMessage', 0, 'Error Message', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ExpectedToken', 0, 'Expected Token [Historical]', NULL, 'java.lang.Integer')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'FailureReason', 0, 'Failure Reason', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'FeeAmount', 0, 'Fee Amount', NULL, 'com.intuit.spc.foundations.primary.SpcfMoney')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'FeeBillingDetailId', 0, 'Fee Billing Detail Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'FeeType', 0, 'Fee Type', NULL, 'com.intuit.sbd.payroll.psp.domain.FeeTypeCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'FinancialTransactionId', 0, 'Financial Transaction Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
...
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'IntuitInitiated', 0, 'Intuit Initiated Reversal', NULL, 'java.lang.Boolean')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'Law', 0, 'Law', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'LimitAmount', 0, 'Limit Amount', NULL, 'com.intuit.spc.foundations.primary.SpcfMoney')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'LimitType', 0, 'Limit Type', NULL, 'com.intuit.sbd.payroll.psp.domain.EventLimitCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ManualStrikeReasonDescription', 0, 'Manual Strike Reason Description', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'MessageLevel', 0, 'Message Level of Error or Warning', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewAccountNumber', 0, 'New Account Number', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewAccountType', 0, 'New Account Type', NULL, 'com.intuit.sbd.payroll.psp.domain.BankAccountType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewAchAccountType', 0, 'New Ach Account Type', NULL, 'com.intuit.sbd.payroll.psp.domain.ACHBankAccountType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewAmount', 0, 'New Amount', NULL, 'com.intuit.spc.foundations.primary.SpcfMoney')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewBAStatus', 0, 'New Bank Account Status', NULL, 'com.intuit.sbd.payroll.psp.domain.BankAccountStatus')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewCoaName', 0, 'New Chart Of Accounts Name', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewDate', 0, 'New Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewLimitAmount', 0, 'New Limit Amount', NULL, 'com.intuit.spc.foundations.primary.SpcfMoney')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewOnHoldReason', 0, 'New OnHold Reason', NULL, 'com.intuit.sbd.payroll.psp.domain.ServiceSubStatusCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewPayrollStatus', 0, 'New Payroll Status', NULL, 'com.intuit.sbd.payroll.psp.domain.PayrollStatus')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewRoutingNumber', 0, 'New Routing Number', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewServiceStatus', 0, 'New Service Status', NULL, 'com.intuit.sbd.payroll.psp.domain.ServiceSubStatusCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewStringValue', 0, 'New Value', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NoteText', 0, 'Note Text', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NSFSubType', 0, 'NSF Subtype', NULL, 'com.intuit.sbd.payroll.psp.domain.NSFSubTypeType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OffloadDate', 0, 'Offload Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldAccountNumber', 0, 'Old Account Number', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldAccountType', 0, 'Old Account Type', NULL, 'com.intuit.sbd.payroll.psp.domain.BankAccountType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldAchAccountType', 0, 'Old Ach Account Type', NULL, 'com.intuit.sbd.payroll.psp.domain.ACHBankAccountType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldAmount', 0, 'Old Amount', NULL, 'com.intuit.spc.foundations.primary.SpcfMoney')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldBAStatus', 0, 'Old Bank Account Status', NULL, 'com.intuit.sbd.payroll.psp.domain.BankAccountStatus')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldCoaName', 0, 'Old Chart Of Accounts Name', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldDate', 0, 'Old Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldLimitAmount', 0, 'Old Limit Amount', NULL, 'com.intuit.spc.foundations.primary.SpcfMoney')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldOnHoldReason', 0, 'Old OnHold Reason', NULL, 'com.intuit.sbd.payroll.psp.domain.ServiceSubStatusCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldPayrollStatus', 0, 'Old Payroll Status', NULL, 'com.intuit.sbd.payroll.psp.domain.PayrollStatus')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldRoutingNumber', 0, 'Old Routing Number', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldServiceStatus', 0, 'Old Service Status', NULL, 'com.intuit.sbd.payroll.psp.domain.ServiceSubStatusCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldStringValue', 0, 'Old Value', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OverrideRecipientEmailAddress', 0, 'Override Recipient Email Address ', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaycheckAmount', 0, 'Paycheck Amount', NULL, 'com.intuit.spc.foundations.primary.SpcfMoney')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaycheckDate', 0, 'Paycheck Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaycheckId', 0, 'Paycheck Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaycheckInvalidReason', 0, 'Reason Paycheck was invalid', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayeeBankAccountId', 0, 'Payee Bank Account Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayeeId', 0, 'Payee Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayeeName', 0, 'Payee Name', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaymentDueDate', 0, 'Payment Due Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaymentInitiationDate', 0, 'Payment Initiation Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaymentMethod', 0, 'Payment Method', NULL, 'com.intuit.sbd.payroll.psp.domain.PaymentMethod')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayrollCancellationReason', 0, 'Cancellation Reason', NULL, 'com.intuit.sbd.payroll.psp.domain.CancellationReasonCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayrollCancellationScope', 0, 'Cancellation Scope', NULL, 'com.intuit.sbd.payroll.psp.domain.CancellationScopeCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayrollRejectedReason', 0, 'Payroll Rejected Reason', NULL, 'com.intuit.sbd.payroll.psp.domain.PayrollRejectedReason')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayrollRunId', 0, 'Payroll Run Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayrollStatus', 0, 'Payroll Status', NULL, 'com.intuit.sbd.payroll.psp.domain.PayrollStatus')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'Percentage', 0, 'Percentage', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ReasonDescription', 0, 'Reason Description', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ReceivedToken', 0, 'Received Token [Historical]', NULL, 'java.lang.Integer')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'RefundAmount', 0, 'Refund Amount', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'RefundedFeeBillingDetailId', 0, 'Refunded Fee Billing Detail Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'RefundStatus', 0, 'Refund Status', NULL, 'com.intuit.sbd.payroll.psp.domain.RefundStatusType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'RefundStatusReason', 0, 'Refund Status Reason', NULL, 'com.intuit.sbd.payroll.psp.domain.RefundStatusReasonType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ReturnType', 0, 'Return Type', NULL, 'com.intuit.sbd.payroll.psp.domain.ACHReturnType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ServiceCode', 0, 'Service Code', NULL, 'com.intuit.sbd.payroll.psp.domain.ServiceCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ServiceStatus', 0, 'Service Status', NULL, 'com.intuit.sbd.payroll.psp.domain.ServiceSubStatusCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'SourceBankAccountId', 0, 'Source Bank Account Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'SourceEmployeeId', 0, 'Source Employee Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'SourcePaycheckId', 0, 'Source Paycheck Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'SourcePayrollRunId', 0, 'Source System Payroll Run Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'StrikeReason', 0, 'Strike Reason', NULL, 'com.intuit.sbd.payroll.psp.domain.StrikeReason')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'Timestamp', 0, 'Timestamp', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'TransmissionId', 0, 'Transmission Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'UniqueIdentifier', 0, 'Unique Identifier', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'UserId', 0, 'User Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'VerificationStatus', 0, 'Verification Status', NULL, 'com.intuit.sbd.payroll.psp.domain.VerificationStatusType')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ViolationAmount', 0, 'Violation Amount', NULL, 'com.intuit.spc.foundations.primary.SpcfMoney')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'WireExpectedDate', 0, 'Wire Expected Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'GenericEventDetail', 0, 'Generic Name,Value Pair', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewEffectiveDate', 0, 'New Effective Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldEffectiveDate', 0, 'Old Effective Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewDepositFrequency', 0, 'New Deposit Frequency', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldDepositFrequency', 0, 'Old Deposit Frequency', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaymentTemplate', 0, 'Payment Template Code', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldEmployeeBankAccountId', 0, 'Old Employee Bank Account Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewEmployeeBankAccountId', 0, 'New Employee Bank Account Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'SourceSystemTransmissionInvalidReason', 0, 'Reason Source System Transmission was invalid', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaymentEFTNumber', 0, 'Tax Payment Electronic Funds Transfer Transaction Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaymentAcknowledgeNumber', 0, 'Tax Payment Agency Acknowledgement Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'MoneyMovementTransactionId', 0, 'Money Movement Transaction Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CompanyTIN', 0, 'Agency Taxpayer Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PaymentPeriodEndDate', 0, 'Tax Period End Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'SourceCompanyId', 0, 'Source Company Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OFXToken', 0, 'OFX Token', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NextEmployeeId', 0, 'NextEmployeeId', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NextPaylineTransactionId', 0, 'NextPaylineTransactionId', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NextPayrollTransactionId', 0, 'NextPayrollTransactionId', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NextPaycheckId', 0, 'NextPaycheckId', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EntitlementId', 0, 'Entitlement Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EntitlementUnitId', 0, 'Entitlement Unit Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'Description', 0, 'Description', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'InvalidatedDepositFrequencyId', 0, 'Invalidated Deposit Frequency Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'TransactionType', 0, 'Transaction Type Code', NULL, 'com.intuit.sbd.payroll.psp.domain.TransactionTypeCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ThresholdPeriodStartDate', 0, 'Threshold Period Start Date', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ThresholdPeriodEndDate', 0, 'Threshold Period End Date', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PermanentPaymentFrequencyId', 0, 'Permanent Payment Deposit Frequency Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ThresholdReversed', 0, 'Threshold reversed', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PenaltiesRefundAmount', 0, 'Penalties refund amount', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'InterestRefundAmount', 0, 'Interest refund amount', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'TotalRefundAmount', 0, 'Total refund amount', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'RefundDebitAmount', 0, 'Refund Debit amount', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ACHEnrollmentId', 0, 'ACH Enrollment Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'RecipientEmailAddress', 0, 'Recipient Email Address', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EmailTemplateType', 0, 'Event Email Template Type code', NULL, 'com.intuit.sbd.payroll.psp.domain.EventEmailTemplateTypeCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'VendorInvalidEmail', 0, 'Vendor invalid email', NULL, 'com.intuit.sbd.payroll.psp.domain.EventEmailTemplateTypeCode')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
  'OldCompanyBankAccountId', 0, 'Old Company Bank Account Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
  'OldPayeeBankAccountNumber', 0, 'Old Payee Bank Account num', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
  'NewPayeeBankAccountNumber', 0, 'New Payee Bank Account num', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
  'OldPayeeBankRoutingNumber', 0, 'Old Payee Bank Routing Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
  'NewPayeeBankRoutingNumber', 0, 'New Payee Bank Routing Id', NULL, 'com.intuit.spc.foundations.portability.SpcfUniqueId')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
  'FirstPayrollRunDate', 0, 'First Payroll Run Date', NULL, 'com.intuit.spc.foundations.portability.util.SpcfCalendar')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
  'PayrollCount', 0, 'Payroll Count', NULL, 'java.lang.Long')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'DataRealmId', 0, 'Company Realm Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'GrantType', 0, 'Grant type ', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'WorkflowId', 0, 'Workflow details', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'AuthId', 0, 'authentication Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'BillingRealmId', 0, 'Billing Realm Id with Payroll purchase', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'WorkOrderId', 0, 'Work Order Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EmployeeSequence', 0, 'Employee Sequence', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'WorkOrderCreatedTime', 0, 'WorkOrder Created Time', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ServiceKey', 0, 'Service Key', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CompanySequence', 0, 'Company Sequence', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CompanyName', 0, 'Company Name', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ConsentValue', 0, 'Consent Value', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'AppName', 0, 'Consent App Name', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EmailTemplate', 0, 'Email Template Name', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'InvitationSource', 0, 'Invitation Source Name', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'IUSInvitationId', 0, 'IUS Invitation Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PersonaId', 0, 'Persona Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NewWalletId', 0, 'New Wallet Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldWalletId', 0, 'Old Wallet Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'CompanyRealmId', 0, 'Company Realm Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OldCompanyRealmId', 0, 'Old Company Realm Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'ConsumerRealmId', 0, 'Consumer Realm Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OwnerOldLimit', 0, 'Owner Old Limit', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'OwnerNewLimit', 0, 'Owner New Limit', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayeeOldLimit', 0, 'Payee Old Limit', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'PayeeNewLimit', 0, 'Payee New Limit', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'VendorId', 0, 'Vendor Id', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'BillingFrequencyType', 0, 'Billing Frequency Type', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'NextChargeDate', 0, 'Next Charge Date', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'BaseRate', 0, 'Base Rate', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'LicenseNumber', 0, 'License Number', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'EntitlementOfferingCode', 0, 'Entitlement Offering Code', NULL, 'java.lang.String')
;
INSERT INTO TEMP_EVENT_DETAIL_TYPE ( EVENT_DETAIL_TYPE_CD, VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME ) VALUES (
'DaysTillRenewal', 0, 'Days Till Renewal', NULL, 'java.lang.String')
;
--------------------------------------------------------
...
SET (VERSION, NAME, DESCRIPTION, EVENT_GROUP_CD) =
...
SET (VERSION, NAME, DESCRIPTION, VALUE_CLASS_NAME) =
