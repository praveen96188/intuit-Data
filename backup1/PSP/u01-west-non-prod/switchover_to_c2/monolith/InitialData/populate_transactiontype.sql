DROP TABLE IF EXISTS TEMP_PSP_TRANSACTION_TYPE CASCADE

;
--------------------------------------------------------
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_PSP_TRANSACTION_TYPE (LIKE PSP_TRANSACTION_TYPE INCLUDING ALL)
...
SET ( NAME, DESCRIPTION, VERSION, TRANSACTION_CATEGORY, ASSOCIATION_TYPE, FEE_IND, N_A_C_H_A_BATCH_TYPE, TRANSACTION_TYPE_GROUP_CD, INCLUDE_IN_TXN_RESPONSE) =
