DROP TABLE IF EXISTS TEMP_PSP_SERVICE_STATUS CASCADE;

--------------------------------------------------------
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_PSP_SERVICE_STATUS (LIKE PSP_SERVICE_STATUS INCLUDING ALL) ;



DROP TABLE IF EXISTS TEMP_PSP_SERVICE_SUB_STATUS CASCADE;

--------------------------------------------------------
-- Create temp table                                  --
--------------------------------------------------------
CREATE TABLE TEMP_PSP_SERVICE_SUB_STATUS (LIKE PSP_SERVICE_SUB_STATUS INCLUDING ALL) ;
...
SET ( NAME, DESCRIPTION, VERSION, SERVICE_STATUS_FK, IS_SET_MANUALLY, IS_REMOVED_MANUALLY) =
