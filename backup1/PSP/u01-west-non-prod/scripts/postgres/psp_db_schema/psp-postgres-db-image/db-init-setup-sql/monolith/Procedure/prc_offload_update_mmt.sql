...
BEGIN
    ...
    CALL PRC_SET_PSP_EVENT_LOG(
            ...
            to_char(timezone('UTC', cast(FN_GET_PSP_TIMESTAMP() AS timestamptz)),
                    'YYYY-MM-DD"T"HH24:MI:SS'), -- p_MessageDTTM TODO Replace CURRENT_TIMESTAMP with FN_GET_PSP_TIMESTAMP
