        ...
        FOR payment_detail_rec IN payment_file_cursor
            ...
            BEGIN
                ...
                WHEN no_data_found  THEN -- as400 files
                    ...
                    RAISE NOTICE 'PRC_EFTPS_PAYMENTS_RETURN_1 ERROR context=% sqlState=% message=% detail=% hint=%', v_error_context, v_error_sqlState, v_error_message, v_error_detail, v_error_hint;
                  RAISE;
              WHEN OTHERS THEN
                  ...
                  GET STACKED DIAGNOSTICS
                      ...
                      v_error_detail = PG_EXCEPTION_DETAIL,
                      v_error_hint = PG_EXCEPTION_HINT;
                  RAISE NOTICE 'PRC_EFTPS_PAYMENTS_RETURN_2 ERROR context=% sqlState=% message=% detail=% hint=%', v_error_context, v_error_sqlState, v_error_message, v_error_detail, v_error_hint;
                  END;
